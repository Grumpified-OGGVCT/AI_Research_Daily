...
**rfuiid8/humanoid-barista-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rfuiid8/humanoid-barista-model)

**rfuiid8/humanoid-anker-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rfuiid8/humanoid-anker-model)

**Haeryz/Deepseek-TPPO-V1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Haeryz/Deepseek-TPPO-V1)

**eekay/gemma-2b-it-steer-lion-numbers-ft-single-l11**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/eekay/gemma-2b-it-steer-lion-numbers-ft-single-l11)

**AdoCleanCode/llasa_stage1_trained_v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdoCleanCode/llasa_stage1_trained_v2)
...
- rfuiid8/humanoid-barista-model... (watch for citations and replications)
- rfuiid8/humanoid-anker-model... (watch for citations and replications)
- Haeryz/Deepseek-TPPO-V1... (watch for citations and replications)
