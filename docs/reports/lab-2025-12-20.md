...
- [🤗 View on HuggingFace](https://huggingface.co/tartuNLP/Llama-3.1-EstLLM-8B-0525)

**Ekrem-the-second/Nano_Ethos50M**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ekrem-the-second/Nano_Ethos50M)

**marcelovidigal/smollm3-3b-dpo-finetuned-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/marcelovidigal/smollm3-3b-dpo-finetuned-v2)

**pthinc/prettybird_bce_basic_coder_8b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/pthinc/prettybird_bce_basic_coder_8b)

**myatsu/whisper-small-burmese**

- Type: model
- Research Score: 0.40
- Community Interest: 27 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/myatsu/whisper-small-burmese)
