...
- **Notable Contributions**: 116 papers scored ≥0.6 (meaningful advances)
...
- [🤗 View on HuggingFace](https://huggingface.co/Francine22/Emma_New)
...
**AmirHossein2002/Qwen2.5-1.5B-Instruct-calib-grpo-dpo-high**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AmirHossein2002/Qwen2.5-1.5B-Instruct-calib-grpo-dpo-high)

**babaongu/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-reclusive_hardy_mongoose**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/babaongu/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-reclusive_hardy_mongoose)
