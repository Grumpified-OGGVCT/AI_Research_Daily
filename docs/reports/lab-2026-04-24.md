...
- [🤗 View on HuggingFace](https://huggingface.co/tobil/qmd-query-expansion-0.6B-sft-improved)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mr-J-369/intorealismUltra_v30-SDXL-qnn2.28)

**yufeng1/Olmo3-7B-reasoning-full-lora-max-type3-e3-1e5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yufeng1/Olmo3-7B-reasoning-full-lora-max-type3-e3-1e5)
...
- tobil/qmd-query-expansion-0.6B-sft-improved... (watch for citations and replications)
- Mr-J-369/intorealismUltra_v30-SDXL-qnn2.28... (watch for citations and replications)
- yufeng1/Olmo3-7B-reasoning-full-lora-max-type3-e3-1e5... (watch for citations and replications)
