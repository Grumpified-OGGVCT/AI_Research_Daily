...
**LLM-course/chess-submission-v16-MDaytek**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess-submission-v16-MDaytek)

**Aekanun/airevade-dpo-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Aekanun/airevade-dpo-v2)

**LLM-course/chess-model-qtb-v3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess-model-qtb-v3)

**LLM-course/chess-submission-v15-MDaytek**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess-submission-v15-MDaytek)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yufeng1/R1-Distill-Qwen-7B-summary-type3-e1-10000)
...
- [LLM-course/chess-submission-v16-MDaytek](https://huggingface.co/LLM-course/chess-submission-v16-MDaytek)
- [LLM-course/chess-model-qtb-v3](https://huggingface.co/LLM-course/chess-model-qtb-v3)
- [LLM-course/chess-submission-v15-MDaytek](https://huggingface.co/LLM-course/chess-submission-v15-MDaytek)
- [LLM-course/chess-submission-v13-MDaytek](https://huggingface.co/LLM-course/chess-submission-v13-MDaytek)
...
- LLM-course/chess-submission-v16-MDaytek... (watch for citations and replications)
- Aekanun/airevade-dpo-v2... (watch for citations and replications)
- LLM-course/chess-model-qtb-v3... (watch for citations and replications)
