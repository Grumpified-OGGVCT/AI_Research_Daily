...
- [🤗 View on HuggingFace](https://huggingface.co/xJoePec/checkpoint-8000-biomimetic)

**dianavdavidson/indicwav2vec-hindi-mucs-62256-hinglish_mixed_scripts-alldata-1e-4-epochs-100-FT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dianavdavidson/indicwav2vec-hindi-mucs-62256-hinglish_mixed_scripts-alldata-1e-4-epochs-100-FT)
...
- [🤗 View on HuggingFace](https://huggingface.co/qtum/Qwen3-Coder-30B-A3B-Audit)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/spkc83/retail-bank-servicing-agent-9b-peft-v14-prompt-realized)
...
- [🤗 View on HuggingFace](https://huggingface.co/tiantiaf/childvox-babblecor-whisper-base)
