...
- Type: dataset
- Research Score: 0.50
- Community Interest: 11,104 downloads, 13 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/DEH-image-scan-data)

**kairawal/Qwen3-32B-DA-SynthDolly-E8-S9**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kairawal/Qwen3-32B-DA-SynthDolly-E8-S9)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/3huvan/inlegalbert3)

**lapppy1/yoruba-emotion-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lapppy1/yoruba-emotion-model)

**Isabeljuradoj27/distilbert**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Isabeljuradoj27/distilbert)
...
- [3huvan/inlegalbert3](https://huggingface.co/3huvan/inlegalbert3)
- [Isabeljuradoj27/distilbert](https://huggingface.co/Isabeljuradoj27/distilbert)
...
- kairawal/Qwen3-32B-DA-SynthDolly-E8-S9... (watch for citations and replications)
- 3huvan/inlegalbert3... (watch for citations and replications)
