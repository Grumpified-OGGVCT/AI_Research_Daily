...
- [🤗 View on HuggingFace](https://huggingface.co/plawanrath/qwen2.5-7b-instruct-bf16-mlx-cba)
...
- [🤗 View on HuggingFace](https://huggingface.co/VladShash/deepseek-math-full-7B-lean-prover-dpo-mistral)

**kairawal/Qwen3-4B-GA-SynthDolly-E1-S73**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kairawal/Qwen3-4B-GA-SynthDolly-E1-S73)

**majid2230/crypto-drv4-sft-r5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/majid2230/crypto-drv4-sft-r5)
...
- plawanrath/qwen2.5-7b-instruct-bf16-mlx-cba... (watch for citations and replications)
- mradermacher/m51Lab-MiniMax-M2.7-REAP-139B-A10B-GGUF... (watch for citations and replications)
- VladShash/deepseek-math-full-7B-lean-prover-dpo-mistral... (watch for citations and replications)
