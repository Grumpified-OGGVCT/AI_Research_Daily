...
- Type: model
- Research Score: 0.50
- Community Interest: 957,172 downloads, 797 likes
- [🤗 View on HuggingFace](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16)

**huggingface/DEH-image-scan-data**

- Type: dataset
- Research Score: 0.50
- Community Interest: 36,702 downloads, 15 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/DEH-image-scan-data)

**fpadovani/hin-deva-100mb-ppt-Dp-10mb_seed455**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/hin-deva-100mb-ppt-Dp-10mb_seed455)

**inferencerlabs/Macaron-V1-Venti-Coder-MLX-Q4.8-INF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/Macaron-V1-Venti-Coder-MLX-Q4.8-INF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/benlahner/valleygirl-1.5b)
...
- [antmoney/hybrid-gpt-232m-chat](https://huggingface.co/antmoney/hybrid-gpt-232m-chat)
- [antmoney/hybrid-gpt-232m](https://huggingface.co/antmoney/hybrid-gpt-232m)
...
- nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16... (watch for citations and replications)
- huggingface/DEH-image-scan-data... (watch for citations and replications)
- fpadovani/hin-deva-100mb-ppt-Dp-10mb_seed455... (watch for citations and replications)
