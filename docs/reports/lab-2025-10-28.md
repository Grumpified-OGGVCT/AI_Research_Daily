...
- Type: model
- Research Score: 0.50
- Community Interest: 10,997 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/YasynAly/SN383)

**DervlexVenice/undressing_concept-style-pony**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DervlexVenice/undressing_concept-style-pony)

**DervlexVenice/round_glasses_accessory-clothing-1.5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DervlexVenice/round_glasses_accessory-clothing-1.5)

**DervlexVenice/rabbit_rabbit-character-1.5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DervlexVenice/rabbit_rabbit-character-1.5)

**vladosics/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-alert_winged_shark**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/vladosics/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-alert_winged_shark)
...
- YasynAly/SN383... (watch for citations and replications)
- DervlexVenice/undressing_concept-style-pony... (watch for citations and replications)
- DervlexVenice/round_glasses_accessory-clothing-1.5... (watch for citations and replications)
...
- **Total Papers Scanned**: 22
- **High-Relevance Papers**: 22
