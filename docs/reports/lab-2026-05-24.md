...
- Type: dataset
- Research Score: 0.50
- Community Interest: 32,311 downloads, 318 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/H831A/yaqeen.models)
...
- [🤗 View on HuggingFace](https://huggingface.co/lintonsui/OmoTalk-3B-V1-Instruct)

**Shagufta/facebook-mms-1b-all-km-indomain20-withac**

- Type: model
- Research Score: 0.40
- Community Interest: 118 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Shagufta/facebook-mms-1b-all-km-indomain20-withac)

**LandonAbundre/BWS_h41ry**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LandonAbundre/BWS_h41ry)
...
- H831A/yaqeen.models... (watch for citations and replications)
- lintonsui/OmoTalk-3B-V1-Instruct... (watch for citations and replications)
