...
**trinhkhng/linear_Merged_gpt2-medium_0.4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.4)

**layaiyer/Politifact_fake_news-syn-arxiv-verbs-dict**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/layaiyer/Politifact_fake_news-syn-arxiv-verbs-dict)

**trinhkhng/linear_Merged_gpt2-medium_0.3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.3)

**trinhkhng/linear_Merged_gpt2-medium_0.2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.2)

**layaiyer/Politifact_fake_news-syn-youtube-nouns-vanilla**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/layaiyer/Politifact_fake_news-syn-youtube-nouns-vanilla)
...
- [trinhkhng/linear_Merged_gpt2-medium_0.4](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.4)
- [trinhkhng/linear_Merged_gpt2-medium_0.3](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.3)
- [trinhkhng/linear_Merged_gpt2-medium_0.2](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.2)
- [trinhkhng/linear_Merged_gpt2-medium_0.1](https://huggingface.co/trinhkhng/linear_Merged_gpt2-medium_0.1)
...
- trinhkhng/linear_Merged_gpt2-medium_0.4... (watch for citations and replications)
- layaiyer/Politifact_fake_news-syn-arxiv-verbs-dict... (watch for citations and replications)
- trinhkhng/linear_Merged_gpt2-medium_0.3... (watch for citations and replications)
