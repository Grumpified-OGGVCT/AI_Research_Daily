...
**csikasote/mms-1b-all-swagen-gender-specific-5hrs-dnn-42**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/csikasote/mms-1b-all-swagen-gender-specific-5hrs-dnn-42)

**aarontseng/meteor-4-11-2025-4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aarontseng/meteor-4-11-2025-4)

**Lamapi/next-14b-Q4_K_M-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lamapi/next-14b-Q4_K_M-GGUF)

**hwazi/content-violation-detector**

- Type: model
- Research Score: 0.40
- Community Interest: 117 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hwazi/content-violation-detector)

**Pascol53/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-extinct_agile_baboon**

- Type: model
- Research Score: 0.40
- Community Interest: 120 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Pascol53/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-extinct_agile_baboon)
...
- csikasote/mms-1b-all-swagen-gender-specific-5hrs-dnn-42... (watch for citations and replications)
- aarontseng/meteor-4-11-2025-4... (watch for citations and replications)
- Lamapi/next-14b-Q4_K_M-GGUF... (watch for citations and replications)
