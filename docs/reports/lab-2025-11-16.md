...
- Type: model
- Research Score: 0.50
- Community Interest: 18,414 downloads, 338 likes
- [🤗 View on HuggingFace](https://huggingface.co/JujoHotaru/lora)

**edwinosky/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-galloping_masked_jaguar**

- Type: model
- Research Score: 0.40
- Community Interest: 372 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/edwinosky/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-galloping_masked_jaguar)

**Ukhagani/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-yapping_slimy_tarantula**

- Type: model
- Research Score: 0.40
- Community Interest: 337 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ukhagani/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-yapping_slimy_tarantula)
...
**deeksyn/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-mimic_bipedal_beaver**

- Type: model
- Research Score: 0.40
- Community Interest: 342 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deeksyn/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-mimic_bipedal_beaver)
...
- JujoHotaru/lora... (watch for citations and replications)
- edwinosky/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-galloping... (watch for citations and replications)
- Ukhagani/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-yapping_slimy_ta... (watch for citations and replications)
