...
**tu-ericngo/llama-3.1-8B-StructuredIE-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tu-ericngo/llama-3.1-8B-StructuredIE-v2)

**chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-grassy_wary_sealion**

- Type: model
- Research Score: 0.40
- Community Interest: 339 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-grassy_wary_sealion)

**dlaima/bart-highlightsum-merged**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dlaima/bart-highlightsum-merged)

**lingshanCeR/bee-iric**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lingshanCeR/bee-iric)
