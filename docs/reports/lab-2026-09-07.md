...
- [🤗 View on HuggingFace](https://huggingface.co/JonaECG/netelpro-qwen2.5-1.5b-honest)

**yunjae-won/Tulu-3.1-3B-SFT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yunjae-won/Tulu-3.1-3B-SFT)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/imtixz/gemma-2-2b-it-sleeper-multi-token-roman-empire-poison1pct)

**primitive-ai/K2-Horizon-MoVA-36B-A4B-mixed-NVFP4-FP8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/primitive-ai/K2-Horizon-MoVA-36B-A4B-mixed-NVFP4-FP8)
...
- JonaECG/netelpro-qwen2.5-1.5b-honest... (watch for citations and replications)
- yunjae-won/Tulu-3.1-3B-SFT... (watch for citations and replications)
- imtixz/gemma-2-2b-it-sleeper-multi-token-roman-empire-poison... (watch for citations and replications)
