...
- **Noteworthy Research**: 14 papers scored ≥0.8 (breakthrough/highly significant)
- **Notable Contributions**: 123 papers scored ≥0.6 (meaningful advances)
- **Implementation Watch**: 36 new models/datasets on HuggingFace
...
### 1. 3D-TDA -- Topological feature extraction from 3D images for Alzheimer's disease classification

**Authors**: Faisal Ahmed et al.  
**Research Score**: 0.97 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: Now that disease-modifying therapies for Alzheimer disease have been approved by regulatory agencies, the early, objective, and accurate clinical diagnosis of AD based on the lowest-cost measurement modalities possible has become an increasingly urgent need. In this study, we propose a novel feature...
...
[📄 Read Paper](https://arxiv.org/abs/2511.08663v1)

---

### 2. TransactionGPT

**Authors**: Yingtong Dou et al.  
**Research Score**: 0.93 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: We present TransactionGPT (TGPT), a foundation model for consumer transaction data within one of world's largest payment networks. TGPT is designed to understand and generate transaction trajectories while simultaneously supporting a variety of downstream prediction and classification tasks. We intr...
...
[📄 Read Paper](https://arxiv.org/abs/2511.08939v1)

---

### 3. SENCA-st: Integrating Spatial Transcriptomics and Histopathology with Cross Attention Shared Encoder for Region Identification in Cancer Pathology

**Authors**: Shanaka Liyanaarachchi et al.  
**Research Score**: 0.92 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: Spatial transcriptomics is an emerging field that enables the identification of functional regions based on the spatial distribution of gene expression. Integrating this functional information present in transcriptomic data with structural data from histopathology images is an active research area w...
...
[📄 Read Paper](https://arxiv.org/abs/2511.08573v1)
...
**Hybrid Quantum-Classical Selective State Space Artificial Intelligence** (Score: 0.79)

Hybrid Quantum Classical (HQC) algorithms constitute one of the most effective paradigms for exploiting the computational advantages of quantum systems in large-scale numerical tasks. By operating in ... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2511.08349v1)

**Causally-Grounded Dual-Path Attention Intervention for Object Hallucination Mitigation in LVLMs** (Score: 0.78)

Object hallucination remains a critical challenge in Large Vision-Language Models (LVLMs), where models generate content inconsistent with visual inputs. Existing language-decoder based mitigation app... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2511.09018v1)

**NeuCLIP: Efficient Large-Scale CLIP Training with Neural Normalizer Optimization** (Score: 0.78)

Accurately estimating the normalization term (also known as the partition function) in the contrastive loss is a central challenge for training Contrastive Language-Image Pre-training (CLIP) models. C... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2511.08417v1)
...
- [🤗 View on HuggingFace](https://huggingface.co/enes1987/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-alert_voracious_salamander)

**AdeWeb3/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-dappled_vocal_antelope**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdeWeb3/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-dappled_vocal_antelope)

**razor534/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stocky_nasty_pheasant**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/razor534/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stocky_nasty_pheasant)

**Dejiat/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-prickly_woolly_seal**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Dejiat/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-prickly_woolly_seal)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/brez47/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-spotted_exotic_raccoon)
...
- [Large Sign Language Models: Toward 3D American Sign Language Translation](https://arxiv.org/abs/2511.08535v1)
- [Anatomy-VLM: A Fine-grained Vision-Language Model for Medical Interpretation](https://arxiv.org/abs/2511.08402v1)
- [PerspAct: Enhancing LLM Situated Collaboration Skills through Perspective Taking and Active Vision](https://arxiv.org/abs/2511.08098v1)
- [ImagebindDC: Compressing Multi-modal Data with Imagebind-based Condensation](https://arxiv.org/abs/2511.08263v1)
...
- [Vector Symbolic Algebras for the Abstraction and Reasoning Corpus](https://arxiv.org/abs/2511.08747v1)
- [From Structure to Detail: Hierarchical Distillation for Efficient Diffusion Model](https://arxiv.org/abs/2511.08930v1)
- [Sharp Eyes and Memory for VideoLLMs: Information-Aware Visual Token Pruning for Efficient and Reliable VideoLLM Reasoning](https://arxiv.org/abs/2511.08003v1)
- [Spatio-Temporal Graph Unlearning](https://arxiv.org/abs/2511.09404v1)
...
**Papers in this cluster**:
- [TransactionGPT](https://arxiv.org/abs/2511.08939v1)
- [Large Sign Language Models: Toward 3D American Sign Language Translation](https://arxiv.org/abs/2511.08535v1)
- [Vector Symbolic Algebras for the Abstraction and Reasoning Corpus](https://arxiv.org/abs/2511.08747v1)
- [Anatomy-VLM: A Fine-grained Vision-Language Model for Medical Interpretation](https://arxiv.org/abs/2511.08402v1)
- [PerspAct: Enhancing LLM Situated Collaboration Skills through Perspective Taking and Active Vision](https://arxiv.org/abs/2511.08098v1)
...
**Papers in this cluster**:
- [3D-TDA -- Topological feature extraction from 3D images for Alzheimer's disease classification](https://arxiv.org/abs/2511.08663v1)
- [SENCA-st: Integrating Spatial Transcriptomics and Histopathology with Cross Attention Shared Encoder for Region Identification in Cancer Pathology](https://arxiv.org/abs/2511.08573v1)
- [Anatomy-VLM: A Fine-grained Vision-Language Model for Medical Interpretation](https://arxiv.org/abs/2511.08402v1)
- [PerspAct: Enhancing LLM Situated Collaboration Skills through Perspective Taking and Active Vision](https://arxiv.org/abs/2511.08098v1)
- [IFG: Internet-Scale Guidance for Functional Grasping Generation](https://arxiv.org/abs/2511.09558v1)
...
- [Vector Symbolic Algebras for the Abstraction and Reasoning Corpus](https://arxiv.org/abs/2511.08747v1)
- [PerspAct: Enhancing LLM Situated Collaboration Skills through Perspective Taking and Active Vision](https://arxiv.org/abs/2511.08098v1)
- [A Neurosymbolic Approach to Natural Language Formalization and Verification](https://arxiv.org/abs/2511.09008v1)
...
- [TransactionGPT](https://arxiv.org/abs/2511.08939v1)
- [SENCA-st: Integrating Spatial Transcriptomics and Histopathology with Cross Attention Shared Encoder for Region Identification in Cancer Pathology](https://arxiv.org/abs/2511.08573v1)
- [Enhancing DPSGD via Per-Sample Momentum and Low-Pass Filtering](https://arxiv.org/abs/2511.08841v1)
- [Vector Symbolic Algebras for the Abstraction and Reasoning Corpus](https://arxiv.org/abs/2511.08747v1)
...
- 3D-TDA -- Topological feature extraction from 3D images for ... (watch for citations and replications)
- TransactionGPT... (watch for citations and replications)
- SENCA-st: Integrating Spatial Transcriptomics and Histopatho... (watch for citations and replications)
...
**1. 3D-TDA -- Topological feature extraction from 3D images for Alzheimer's disease classification** (Score: 0.97) 【breakthrough:1】

*In plain English*: Now that disease-modifying therapies for Alzheimer disease have been approved by regulatory agencies, the early, objective, and accurate clinical diagnosis of AD based on the lowest-cost measurement modalities possible has become an increasingly urge...
...
**2. TransactionGPT** (Score: 0.93) 【breakthrough:2】

*In plain English*: We present TransactionGPT (TGPT), a foundation model for consumer transaction data within one of world's largest payment networks. TGPT is designed to understand and generate transaction trajectories while simultaneously supporting a variety of downs...

**Builder takeaway**: Look for implementations on HuggingFace or GitHub in the next 2-4 weeks. Early adopters can differentiate their products with this approach.

[📄 Read Paper](https://arxiv.org/abs/2511.08939v1)

**3. SENCA-st: Integrating Spatial Transcriptomics and Histopathology with Cross Attention Shared Encoder for Region Identification in Cancer Pathology** (Score: 0.92) 【breakthrough:3】

*In plain English*: Spatial transcriptomics is an emerging field that enables the identification of functional regions based on the spatial distribution of gene expression. Integrating this functional information present in transcriptomic data with structural data from ...
...
- **Total Papers Scanned**: 236
- **High-Relevance Papers**: 236
