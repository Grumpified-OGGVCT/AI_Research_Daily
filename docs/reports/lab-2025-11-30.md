...
- Type: model
- Research Score: 0.40
- Community Interest: 319 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tonyxfinance/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-nimble_grunting_tuna)

**ngbinetou/outputs_full_finetune**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ngbinetou/outputs_full_finetune)
...
- afroneko/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-frisky_for... (watch for citations and replications)
