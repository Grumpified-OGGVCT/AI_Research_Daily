...
**mradermacher/Nemostein-3-Hermes-Omni-30b-a3b-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/Nemostein-3-Hermes-Omni-30b-a3b-i1-GGUF)

**yufeng1/Olmo3-7B-medical-type6-e1-alpha0_375**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yufeng1/Olmo3-7B-medical-type6-e1-alpha0_375)

**yufeng1/Olmo3-7B-medical-type6-e1-alpha0_125**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yufeng1/Olmo3-7B-medical-type6-e1-alpha0_125)

**knmrfr/deepfake-detector**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/knmrfr/deepfake-detector)

**DavidAU/Granite-4.1-43B-Grand-Mountain-Thinking**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/Granite-4.1-43B-Grand-Mountain-Thinking)
...
- mradermacher/Nemostein-3-Hermes-Omni-30b-a3b-i1-GGUF... (watch for citations and replications)
- yufeng1/Olmo3-7B-medical-type6-e1-alpha0_375... (watch for citations and replications)
- yufeng1/Olmo3-7B-medical-type6-e1-alpha0_125... (watch for citations and replications)
