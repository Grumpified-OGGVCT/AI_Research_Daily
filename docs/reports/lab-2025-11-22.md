...
**lyfesan/swinv2transformer-brats-artifact-classifier**

- Type: model
- Research Score: 0.40
- Community Interest: 39 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lyfesan/swinv2transformer-brats-artifact-classifier)

**Papaperez/tau-0.5B-instruct-Gensyn-Swarm-wise_crested_cat**

- Type: model
- Research Score: 0.40
- Community Interest: 406 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Papaperez/tau-0.5B-instruct-Gensyn-Swarm-wise_crested_cat)
...
- [🤗 View on HuggingFace](https://huggingface.co/joekarim/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-foxy_peckish_pigeon)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dqsawDQWD/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-arctic_restless_hummingbird)
