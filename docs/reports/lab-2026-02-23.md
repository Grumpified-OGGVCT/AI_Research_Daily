...
- Type: model
- Research Score: 0.50
- Community Interest: 302,852 downloads, 915 likes
- [🤗 View on HuggingFace](https://huggingface.co/Qwen/Qwen3.5-397B-A17B)

**JealousyGuy/qwen2.5-python-14B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/JealousyGuy/qwen2.5-python-14B)

**bachthetrollface/qwen2.5-7B-inst-teacher-dolly-vllm**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/bachthetrollface/qwen2.5-7B-inst-teacher-dolly-vllm)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/znhoughton/opt-babylm-125m-64eps-seed964)

**MoaazTalab/mobilenet_v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MoaazTalab/mobilenet_v2)
...
- Qwen/Qwen3.5-397B-A17B... (watch for citations and replications)
- JealousyGuy/qwen2.5-python-14B... (watch for citations and replications)
- bachthetrollface/qwen2.5-7B-inst-teacher-dolly-vllm... (watch for citations and replications)
