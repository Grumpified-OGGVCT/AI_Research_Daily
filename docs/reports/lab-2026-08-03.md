...
**biosai-hf/Inkling-MXFP4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/biosai-hf/Inkling-MXFP4)

**OpenSportsLab/OSL-VQA-XFOUL-qwen2.5-VL-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/OpenSportsLab/OSL-VQA-XFOUL-qwen2.5-VL-lora)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/OpenVoiceOS/whisper-large-v3-arabic-dialectal-v2-onnx)

**User01110/AC-5M**

- Type: model
- Research Score: 0.40
- Community Interest: 2 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/User01110/AC-5M)
...
- [sulaimank/w2vbert-shona-waxal-cased](https://huggingface.co/sulaimank/w2vbert-shona-waxal-cased)
...
- biosai-hf/Inkling-MXFP4... (watch for citations and replications)
- OpenSportsLab/OSL-VQA-XFOUL-qwen2.5-VL-lora... (watch for citations and replications)
- OpenVoiceOS/whisper-large-v3-arabic-dialectal-v2-onnx... (watch for citations and replications)
