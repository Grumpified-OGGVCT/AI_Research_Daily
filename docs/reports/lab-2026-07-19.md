...
- Type: dataset
- Research Score: 0.50
- Community Interest: 35,726 downloads, 15 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/DEH-image-scan-data)

**sullivan1502/base-sft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sullivan1502/base-sft)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/tur-latn-100mb-after-ppt-Dp-100mb-ckpt500_seed455)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wz7475/qwen2.5-7b-instruct-katcher-med-lora-null-b-null-v2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pavelslab-nyu/Chess-Pretrain-Models)
...
- sullivan1502/base-sft... (watch for citations and replications)
- fpadovani/tur-latn-100mb-after-ppt-Dp-100mb-ckpt500_seed455... (watch for citations and replications)
