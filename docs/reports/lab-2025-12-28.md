...
**NicolasUnivalle/roberta_vm**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NicolasUnivalle/roberta_vm)

**zhangandi001/Qwen_Zumi_LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zhangandi001/Qwen_Zumi_LoRA)

**mradermacher/Newton-bot-2A-standard_merged-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/Newton-bot-2A-standard_merged-i1-GGUF)

**tiagoft/multiberts-seed_11_imdb_finetuned_final**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tiagoft/multiberts-seed_11_imdb_finetuned_final)
...
- [NicolasUnivalle/roberta_vm](https://huggingface.co/NicolasUnivalle/roberta_vm)
- [tiagoft/multiberts-seed_11_imdb_finetuned_final](https://huggingface.co/tiagoft/multiberts-seed_11_imdb_finetuned_final)
- [tiagoft/multiberts-seed_11_imdb_finetuned_epoch_15](https://huggingface.co/tiagoft/multiberts-seed_11_imdb_finetuned_epoch_15)
- [tiagoft/multiberts-seed_11_imdb_finetuned_epoch_14](https://huggingface.co/tiagoft/multiberts-seed_11_imdb_finetuned_epoch_14)
...
- NicolasUnivalle/roberta_vm... (watch for citations and replications)
- zhangandi001/Qwen_Zumi_LoRA... (watch for citations and replications)
