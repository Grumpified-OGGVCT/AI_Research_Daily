...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mungert/DASD-4B-Thinking-GGUF)
...
- [🤗 View on HuggingFace](https://huggingface.co/llm-semantic-router/mmbert32k-intent-classifier-merged)

**ariefansclub/han-domestic-task-planning-model-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ariefansclub/han-domestic-task-planning-model-v1)
...
- [llm-semantic-router/mmbert32k-intent-classifier-merged](https://huggingface.co/llm-semantic-router/mmbert32k-intent-classifier-merged)
...
- MohamedGomaa30/spark-tts-normazlied-masri-mega... (watch for citations and replications)
- Mungert/DASD-4B-Thinking-GGUF... (watch for citations and replications)
- llm-semantic-router/mmbert32k-jailbreak-detector-merged... (watch for citations and replications)
