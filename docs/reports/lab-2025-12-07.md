...
**tommymir4444/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-feline_energetic_tuna**

- Type: model
- Research Score: 0.40
- Community Interest: 374 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tommymir4444/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-feline_energetic_tuna)
...
**ctaguchi/ssc-kcn-xlsr300m-model-mix-adapt-max-lowlr**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ctaguchi/ssc-kcn-xlsr300m-model-mix-adapt-max-lowlr)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rishabhrj11/distillspec-qwen600m-xsum)

**Haider2117/llama-3-8b-Instruct-medical-merged-16bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Haider2117/llama-3-8b-Instruct-medical-merged-16bit)
...
- [Ksjsjjdj/Tiny-LLM-Z-V0](https://huggingface.co/Ksjsjjdj/Tiny-LLM-Z-V0)
- [siddharthgowda/COMS4705-roberta-tweet-virality-head-only-vfinal](https://huggingface.co/siddharthgowda/COMS4705-roberta-tweet-virality-head-only-vfinal)
...
- tommymir4444/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-feline... (watch for citations and replications)
- yoyofan/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-rugged_elus... (watch for citations and replications)
- ctaguchi/ssc-kcn-xlsr300m-model-mix-adapt-max-lowlr... (watch for citations and replications)
