...
**fpadovani/jpn-jpan-10mb-100mb_seed10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/jpn-jpan-10mb-100mb_seed10)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/keXjos/Huihui-Qwythos-9B-Claude-Mythos-5-1M-abliterated-mlx-8Bit)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/williamliao/Qwen3.6-35B-A3B-NVFP4-GGUF)

**fwwrsd/xzbs_woman-epoch10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fwwrsd/xzbs_woman-epoch10)

**danielruss/is_job_title_gist_small**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/danielruss/is_job_title_gist_small)
