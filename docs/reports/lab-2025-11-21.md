...
**chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-fleecy_waddling_armadillo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-fleecy_waddling_armadillo)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NullAxon/ami-command-recognition-is-command-weighted)

**DevQuasar/ai-sage.GigaChat3-702B-A36B-preview-bf16-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/ai-sage.GigaChat3-702B-A36B-preview-bf16-GGUF)

**DerivedFunction/Qwen3-0.6B-finance-instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 62 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DerivedFunction/Qwen3-0.6B-finance-instruct)
