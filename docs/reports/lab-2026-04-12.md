...
- Type: dataset
- Research Score: 0.50
- Community Interest: 26,025 downloads, 293 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**straviosrex/llama_finetune_16bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/straviosrex/llama_finetune_16bit)
...
- [Cisco1963/llmplasticity-zh_never_1-seed42](https://huggingface.co/Cisco1963/llmplasticity-zh_never_1-seed42)
- [hoangkkk/phobert-v2-vietnamese-sentiment](https://huggingface.co/hoangkkk/phobert-v2-vietnamese-sentiment)
