...
- Type: model
- Research Score: 0.50
- Community Interest: 2,283 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Beetle-HumanScale/beetle-bilingual-balanced-b1-humanscale-nld-eng)

**normant23/detr-fashionpedia**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/normant23/detr-fashionpedia)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/Huihui-Qwen3.5-27B-abliterated-Athanorlite-ORPO-v2-i1-GGUF)

**Outlier-Ai/Outlier-R1-Distill-14B-MLX-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Outlier-Ai/Outlier-R1-Distill-14B-MLX-4bit)

**k0valik-21/Carnice-27b-Q3_K_S-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/k0valik-21/Carnice-27b-Q3_K_S-GGUF)
...
- Beetle-HumanScale/beetle-bilingual-balanced-b1-humanscale-nl... (watch for citations and replications)
- normant23/detr-fashionpedia... (watch for citations and replications)
- mradermacher/Huihui-Qwen3.5-27B-abliterated-Athanorlite-ORPO... (watch for citations and replications)
