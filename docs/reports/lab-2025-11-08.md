...
**BenzHavana/Llama-3.2-3B-Expert-System-vernew**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BenzHavana/Llama-3.2-3B-Expert-System-vernew)

**ZafarAliMengal123/yolov8s-FoodClassifier**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ZafarAliMengal123/yolov8s-FoodClassifier)
...
**Liebert711/Qwen3-0.6B-Gensyn-Swarm-stalking_screeching_kiwi**

- Type: model
- Research Score: 0.40
- Community Interest: 8 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Liebert711/Qwen3-0.6B-Gensyn-Swarm-stalking_screeching_kiwi)
