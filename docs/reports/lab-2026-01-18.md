...
- Type: model
- Research Score: 0.50
- Community Interest: 1,224 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mazesmazes/tiny-audio)

**Darejkal/kaggle-comp-model-20250118**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Darejkal/kaggle-comp-model-20250118)

**ujjawalsingh10/clm-text-generation**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/ujjawalsingh10/clm-text-generation)

**Neelectric/Llama-3.1-8B-Instruct_SFT_Math-220kv00.33**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Neelectric/Llama-3.1-8B-Instruct_SFT_Math-220kv00.33)

**LLM-course/chess-leg-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess-leg-v2)
...
- [LLM-course/chess-leg-v2](https://huggingface.co/LLM-course/chess-leg-v2)
- [kirapika2/distilbert-base-uncased-finetuned-emotion](https://huggingface.co/kirapika2/distilbert-base-uncased-finetuned-emotion)
- [LLM-course/chess-token-ines](https://huggingface.co/LLM-course/chess-token-ines)
- [LLM-course/my-chess-bot-v1](https://huggingface.co/LLM-course/my-chess-bot-v1)
- [LLM-course/fatima-chess-model](https://huggingface.co/LLM-course/fatima-chess-model)
...
- mazesmazes/tiny-audio... (watch for citations and replications)
- Darejkal/kaggle-comp-model-20250118... (watch for citations and replications)
- ujjawalsingh10/clm-text-generation... (watch for citations and replications)
