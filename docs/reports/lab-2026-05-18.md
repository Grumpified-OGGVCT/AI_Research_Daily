...
- [🤗 View on HuggingFace](https://huggingface.co/platypus123/EXACT-Qwen-Trained)

**tarudesu/HSD-mbert-debug**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tarudesu/HSD-mbert-debug)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/danielangelo1/llama-climate-change-stance-ptbr-lora)

**ninjafrmtjk/cpo_qwen_long_long**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ninjafrmtjk/cpo_qwen_long_long)

**ninjafrmtjk/cpo_qwen_random**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ninjafrmtjk/cpo_qwen_random)
...
- platypus123/EXACT-Qwen-Trained... (watch for citations and replications)
- tarudesu/HSD-mbert-debug... (watch for citations and replications)
- danielangelo1/llama-climate-change-stance-ptbr-lora... (watch for citations and replications)
