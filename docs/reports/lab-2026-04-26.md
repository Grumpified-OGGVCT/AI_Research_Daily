...
**xqjiao/qwen25-7b-instruct-dpo-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xqjiao/qwen25-7b-instruct-dpo-lora)

**Afiqa/GPT2-mdpi-medquad**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Afiqa/GPT2-mdpi-medquad)
...
**ashutosh111/negotiation-vendor-llama32-1b-grpo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ashutosh111/negotiation-vendor-llama32-1b-grpo)

**nuhaharbi/ag_news_classifierv2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nuhaharbi/ag_news_classifierv2)
...
- xqjiao/qwen25-7b-instruct-dpo-lora... (watch for citations and replications)
- Afiqa/GPT2-mdpi-medquad... (watch for citations and replications)
- SOTAagi2030/MyAwesomeModel-TestRepo... (watch for citations and replications)
