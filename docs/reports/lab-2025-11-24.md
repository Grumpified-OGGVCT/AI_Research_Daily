...
**dora342/Qwen2.5-1.5B-Instruct-Gensyn-Swarm-tangled_yawning_bat**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dora342/Qwen2.5-1.5B-Instruct-Gensyn-Swarm-tangled_yawning_bat)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Madras1/MTLM1-200M)

**Seanie-lee/R1-8B-direct-refusal-pm**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Seanie-lee/R1-8B-direct-refusal-pm)

**noelsinghsr/learn_hf_food_not_food_text_classifier-distilbert-base-uncased**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/noelsinghsr/learn_hf_food_not_food_text_classifier-distilbert-base-uncased)

**Kina250/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stealthy_wary_sandpiper**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kina250/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stealthy_wary_sandpiper)
...
- dora342/Qwen2.5-1.5B-Instruct-Gensyn-Swarm-tangled_yawning_b... (watch for citations and replications)
- Madras1/MTLM1-200M... (watch for citations and replications)
- Seanie-lee/R1-8B-direct-refusal-pm... (watch for citations and replications)
