...
**aurorapineward/codeassist**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aurorapineward/codeassist)

**fpadovani/cds_sh1_13**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/cds_sh1_13)
...
**ycheng1024/task-17-Qwen-Qwen2.5-3B-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ycheng1024/task-17-Qwen-Qwen2.5-3B-Instruct)
