...
**fpadovani/isl-latn-10mb-100mb_seed455**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/isl-latn-10mb-100mb_seed455)

**arianraje/qwen3-4b-gdn-hybrid-gkd50-baseline**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/arianraje/qwen3-4b-gdn-hybrid-gkd50-baseline)

**arianraje/qwen3-4b-gdn-hybrid-seqkd-baseline**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/arianraje/qwen3-4b-gdn-hybrid-seqkd-baseline)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-OS-Models2/gdn2-370m-fineweb-edu-5b-vanilla)
...
- [LLM-OS-Models2/gdn2-370m-fineweb-edu-5b-vanilla](https://huggingface.co/LLM-OS-Models2/gdn2-370m-fineweb-edu-5b-vanilla)
- [sulaimank/w2vbert-shona-waxal-punct-v2](https://huggingface.co/sulaimank/w2vbert-shona-waxal-punct-v2)
...
- fpadovani/isl-latn-10mb-100mb_seed455... (watch for citations and replications)
- arianraje/qwen3-4b-gdn-hybrid-gkd50-baseline... (watch for citations and replications)
- arianraje/qwen3-4b-gdn-hybrid-seqkd-baseline... (watch for citations and replications)
