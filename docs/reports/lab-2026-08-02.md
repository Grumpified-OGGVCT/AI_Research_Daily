...
- Type: dataset
- Research Score: 0.50
- Community Interest: 55,567 downloads, 15 likes
...
**SENAGI/Moomai-1.2-40M-checkpoints**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SENAGI/Moomai-1.2-40M-checkpoints)
...
- SENAGI/Moomai-1.2-40M-checkpoints... (watch for citations and replications)
