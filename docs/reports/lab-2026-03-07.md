...
- Type: model
- Research Score: 0.40
- Community Interest: 48 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/techwithsergiu/Qwen3.5-text-9B-bnb-4bit)

**Jackrong/Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled**

- Type: model
- Research Score: 0.40
- Community Interest: 4,212 downloads, 136 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jackrong/Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled)

**techwithsergiu/Qwen3.5-text-4B-bnb-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 29 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/techwithsergiu/Qwen3.5-text-4B-bnb-4bit)

**yuna1126/Tema_Q-X2-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 405 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yuna1126/Tema_Q-X2-GGUF)

**techwithsergiu/Qwen3.5-text-2B-bnb-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 33 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/techwithsergiu/Qwen3.5-text-2B-bnb-4bit)
