...
**moogin/lintly-lfm2-700m-dpo-new**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/moogin/lintly-lfm2-700m-dpo-new)

**dousery/functiongemma-mobile-actions**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dousery/functiongemma-mobile-actions)
...
**small-blue/rl-pos-test08_offline**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/small-blue/rl-pos-test08_offline)

**tusharmishra288/distilbert-base-uncased-distilled-clinc**

- Type: model
- Research Score: 0.40
- Community Interest: 9 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tusharmishra288/distilbert-base-uncased-distilled-clinc)
...
- moogin/lintly-lfm2-700m-dpo-new... (watch for citations and replications)
- dousery/functiongemma-mobile-actions... (watch for citations and replications)
