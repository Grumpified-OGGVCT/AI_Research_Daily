...
**richolic/qwen2.5-3b-indonesian-legal-sft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/richolic/qwen2.5-3b-indonesian-legal-sft)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/exnivo/Lume-2B)

**fpadovani/urd-arab-10mb-after-ppt-shuff-dyck-100mb-ckpt500_seed455**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/urd-arab-10mb-after-ppt-shuff-dyck-100mb-ckpt500_seed455)

**quik-models/glowing-water-32**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/quik-models/glowing-water-32)

**AvoCahDoe/morocco-bo-domain-classifier-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AvoCahDoe/morocco-bo-domain-classifier-v1)
...
- richolic/qwen2.5-3b-indonesian-legal-sft... (watch for citations and replications)
- exnivo/Lume-2B... (watch for citations and replications)
