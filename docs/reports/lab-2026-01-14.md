...
- [🤗 View on HuggingFace](https://huggingface.co/denizzay/sabanci-it-destek-v1)

**Sota26/Affine-15-5CvsDmvzsY1aDwZMkM6y7dH9bkHU1s6T2rkaQEFBVWyeQzhV**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Sota26/Affine-15-5CvsDmvzsY1aDwZMkM6y7dH9bkHU1s6T2rkaQEFBVWyeQzhV)

**CausalNLP/gpt2-multilingual-20-deu-repair_3epochs_lr1e-4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/CausalNLP/gpt2-multilingual-20-deu-repair_3epochs_lr1e-4)
...
**Zaynoid/medical-reasoning-qwen3-8b-lora-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Zaynoid/medical-reasoning-qwen3-8b-lora-v1)
...
- **Reasoning**: 46 mentions across papers—this is where the field is moving 【trend:reasoning】
