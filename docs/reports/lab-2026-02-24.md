...
**tazza26/K-EXAONE-236B-SFT-lora-r4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tazza26/K-EXAONE-236B-SFT-lora-r4)
...
**kamaboko2007/llm_advance_014_merged**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kamaboko2007/llm_advance_014_merged)

**pgsyttch/qwen3-4b-agent-trajectory-lora-0222-1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pgsyttch/qwen3-4b-agent-trajectory-lora-0222-1)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/JongYeop/Llama-3.1-8B-Instruct-MXFP4-W4A4)
...
- tazza26/K-EXAONE-236B-SFT-lora-r4... (watch for citations and replications)
- NathanRoll/writing-rlvr-qwen2.5-1.5b... (watch for citations and replications)
- kamaboko2007/llm_advance_014_merged... (watch for citations and replications)
