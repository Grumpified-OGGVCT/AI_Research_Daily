...
- [🤗 View on HuggingFace](https://huggingface.co/Dekonstruktio/1)

**sulaimank/whisper-small-lingala-cased-3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sulaimank/whisper-small-lingala-cased-3)

**tashrifrahman/DeepSeek-R1-Phishing-Detector**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tashrifrahman/DeepSeek-R1-Phishing-Detector)
