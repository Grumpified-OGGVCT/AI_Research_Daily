...
**wenzhouwu/DwarfStar-DeepSeek-V4.1-Flash**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wenzhouwu/DwarfStar-DeepSeek-V4.1-Flash)

**210Codelabs/AdaptIQ-7B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/210Codelabs/AdaptIQ-7B)

**midudev/kev-0.8b-ONNX**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/midudev/kev-0.8b-ONNX)

**RunningHubAI/rh-cyberrealistic-z-image-turbo-unet**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/RunningHubAI/rh-cyberrealistic-z-image-turbo-unet)

**RunningHubAI/rh-zimagelora-1.0-tsune-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/RunningHubAI/rh-zimagelora-1.0-tsune-lora)
...
Today's research firehose scanned **368 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
