...
- [🤗 View on HuggingFace](https://huggingface.co/davidnichols-ops/claude-yolo-vibes)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/stage-babylm/llama-384-2L)
...
- [🤗 View on HuggingFace](https://huggingface.co/Raxephion/Krea2-Serendipity-V1)
...
- davidnichols-ops/claude-yolo-vibes... (watch for citations and replications)
- stage-babylm/llama-384-2L... (watch for citations and replications)
