...
**nikokons/contrastive-deepfake-detector**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nikokons/contrastive-deepfake-detector)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sesaily/Qwen2.5-Coder-7B-Frends-Instruct)

**sameetvipat/polyllm-chairman**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sameetvipat/polyllm-chairman)

**daniloreddy/gemma-4-E2B-it_GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/daniloreddy/gemma-4-E2B-it_GGUF)

**razy101/gemma-3-270m-text-to-emoji-full**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/razy101/gemma-3-270m-text-to-emoji-full)
...
- nikokons/contrastive-deepfake-detector... (watch for citations and replications)
- sesaily/Qwen2.5-Coder-7B-Frends-Instruct... (watch for citations and replications)
- sameetvipat/polyllm-chairman... (watch for citations and replications)
