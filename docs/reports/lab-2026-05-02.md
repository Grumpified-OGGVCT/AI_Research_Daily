...
- Type: model
- Research Score: 0.50
- Community Interest: 1,247 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/MiMo-V2.5-Pro-MLX-4.3bit-INF)

**emiliogirard/counseling-e2e-llama-3.1-8b-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/emiliogirard/counseling-e2e-llama-3.1-8b-lora)

**SrikanthDongala/toxicity-fast-onnx**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SrikanthDongala/toxicity-fast-onnx)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Optitransfer/Qwen2.5-7B-Instruct-borg-merge-v1)

**searcher133/Mistral-7B-v0.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/searcher133/Mistral-7B-v0.1)
...
- [inferencerlabs/MiMo-V2.5-Pro-MLX-4.3bit-INF](https://huggingface.co/inferencerlabs/MiMo-V2.5-Pro-MLX-4.3bit-INF)
- [inferencerlabs/Ling-2.6-MLX-3.6bit-INF](https://huggingface.co/inferencerlabs/Ling-2.6-MLX-3.6bit-INF)
...
- inferencerlabs/MiMo-V2.5-Pro-MLX-4.3bit-INF... (watch for citations and replications)
- emiliogirard/counseling-e2e-llama-3.1-8b-lora... (watch for citations and replications)
- SrikanthDongala/toxicity-fast-onnx... (watch for citations and replications)
