...
- Type: model
- Research Score: 0.50
- Community Interest: 20,957 downloads, 9 likes
- [🤗 View on HuggingFace](https://huggingface.co/nvidia/Nemotron-3-Embed-1B-BF16)

**ismailtasdelen/pinanolm-100m**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ismailtasdelen/pinanolm-100m)

**ranwakhaled/qwen3b-instruct-default**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ranwakhaled/qwen3b-instruct-default)

**SanaullahTareen07/vechile-health-detection-using-computer-vision**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SanaullahTareen07/vechile-health-detection-using-computer-vision)
...
- [🤗 View on HuggingFace](https://huggingface.co/RYVR/qwen2.5-7b-b2b-marketing-lora)
