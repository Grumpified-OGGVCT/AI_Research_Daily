...
**fpadovani/cds_o_new_51**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/cds_o_new_51)

**allenai/dolma3_pool**

- Type: dataset
- Research Score: 0.50
- Community Interest: 51,535 downloads, 19 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/allenai/dolma3_pool)
...
**ctaguchi/ssc-aln-mms-model-initadapt**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ctaguchi/ssc-aln-mms-model-initadapt)
