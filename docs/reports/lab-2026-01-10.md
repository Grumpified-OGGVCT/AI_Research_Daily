...
- Type: model
- Research Score: 0.50
- Community Interest: 8,630 downloads, 111 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kijai/LTXV2_comfy)

**APPA-Clem/Tiny-lamina-English**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/APPA-Clem/Tiny-lamina-English)

**YADAV0206/PathoPreter-4B-SNV-Pathogen-ClinVar-gnomAD**

- Type: model
- Research Score: 0.40
- Community Interest: 7 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/YADAV0206/PathoPreter-4B-SNV-Pathogen-ClinVar-gnomAD)

**TheHassanSaud/gemma3_12B_dpo_newdata_full_checkpoints_v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TheHassanSaud/gemma3_12B_dpo_newdata_full_checkpoints_v2)

**dynann/emotion-classification**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dynann/emotion-classification)
