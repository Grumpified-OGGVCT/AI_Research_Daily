...
- Type: model
- Research Score: 0.50
- Community Interest: 2,272 downloads, 17 likes
- [🤗 View on HuggingFace](https://huggingface.co/GadflyII/GLM-4.7-Flash-NVFP4)

**Zachary1150/tool_merge_linear_1.5B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Zachary1150/tool_merge_linear_1.5B)

**yasker00/qwen3-8B-only-layer-selected-inverse-step90**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yasker00/qwen3-8B-only-layer-selected-inverse-step90)

**yasker00/qwen3-8B-dynamic-layer-selected-inverse-step180**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yasker00/qwen3-8B-dynamic-layer-selected-inverse-step180)

**mradermacher/Qwen3-Next-480E-Abliterated-Instruct-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,005 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/Qwen3-Next-480E-Abliterated-Instruct-i1-GGUF)
...
- GadflyII/GLM-4.7-Flash-NVFP4... (watch for citations and replications)
- Zachary1150/tool_merge_linear_1.5B... (watch for citations and replications)
- yasker00/qwen3-8B-only-layer-selected-inverse-step90... (watch for citations and replications)
