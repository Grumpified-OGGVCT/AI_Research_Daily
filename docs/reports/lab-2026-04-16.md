...
**bazengo/distilhubert-finetuned-gtzan**

- Type: model
- Research Score: 0.40
- Community Interest: 9 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/bazengo/distilhubert-finetuned-gtzan)
...
- [🤗 View on HuggingFace](https://huggingface.co/fares-boutriga/Damork-tx-1)

**Perception365/VehicleNet-RFDETR-n8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Perception365/VehicleNet-RFDETR-n8)

**uzi-9/qwen3-4b-legal-asp**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/uzi-9/qwen3-4b-legal-asp)
