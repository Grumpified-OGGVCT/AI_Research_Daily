...
**fpadovani/candor_word_new_13**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/candor_word_new_13)
...
- Type: model
- Research Score: 0.40
- Community Interest: 467 downloads, 0 likes
...
- fpadovani/candor_word_new_13... (watch for citations and replications)
- xinnn32/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-sniffing_ya... (watch for citations and replications)
- reggiehub/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-horned_ja... (watch for citations and replications)
