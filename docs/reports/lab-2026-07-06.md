...
- [🤗 View on HuggingFace](https://huggingface.co/SceneWorks/krea-2-raw-mlx)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 22,478 downloads, 330 likes
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/achavan1211/SmolLM3-Custom-SFT)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pipenetwork/LongCat-2.0-6bit)

**felycia/flux2-guardrail-verification**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/felycia/flux2-guardrail-verification)
...
- [achavan1211/SmolLM3-Custom-SFT](https://huggingface.co/achavan1211/SmolLM3-Custom-SFT)
- [MarxistLeninist/AGILLM-4.3](https://huggingface.co/MarxistLeninist/AGILLM-4.3)
...
- SceneWorks/krea-2-raw-mlx... (watch for citations and replications)
- open-index/hacker-news... (watch for citations and replications)
- achavan1211/SmolLM3-Custom-SFT... (watch for citations and replications)
