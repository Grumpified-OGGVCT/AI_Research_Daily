...
**seeib/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-prehistoric_gregarious_seahorse**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/seeib/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-prehistoric_gregarious_seahorse)

**Blueforce99/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-bristly_bellowing_fox**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Blueforce99/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-bristly_bellowing_fox)

**magiccodingman/Qwen3-4B-Instruct-2507-MXFP4-Hybrid-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 145 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/magiccodingman/Qwen3-4B-Instruct-2507-MXFP4-Hybrid-GGUF)

**sourled/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-trotting_rabid_cat**

- Type: model
- Research Score: 0.40
- Community Interest: 356 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sourled/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-trotting_rabid_cat)
