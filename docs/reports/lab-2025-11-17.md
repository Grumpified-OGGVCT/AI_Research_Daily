...
**XSCP/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-masked_slender_marmot**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/XSCP/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-masked_slender_marmot)
...
- Type: model
- Research Score: 0.40
- Community Interest: 362 downloads, 0 likes
...
- Type: model
- Research Score: 0.40
- Community Interest: 1,377 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/0xgr3y/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-tall_tame_panther)
...
- XSCP/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-masked_slender... (watch for citations and replications)
...
- **Total Papers Scanned**: 23
- **High-Relevance Papers**: 23
