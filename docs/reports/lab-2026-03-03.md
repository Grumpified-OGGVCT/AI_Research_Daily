...
**AbdelmomenMoula/Weather-GPT-France**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AbdelmomenMoula/Weather-GPT-France)

**BrightHub2/lora-emotional-intelligence-a2de86d6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BrightHub2/lora-emotional-intelligence-a2de86d6)

**masaom/32_qwen2_5-7b-agent-baseline_DB-ALF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/masaom/32_qwen2_5-7b-agent-baseline_DB-ALF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/UmbrellaInc/Prototype-Virus-1B)

**qqggez/deepseek-parlay-6.7b**

- Type: model
- Research Score: 0.40
- Community Interest: 10 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/qqggez/deepseek-parlay-6.7b)
...
- [AbdelmomenMoula/Weather-GPT-France](https://huggingface.co/AbdelmomenMoula/Weather-GPT-France)
- [omar-hatem/modernBERT_classifier_tuned](https://huggingface.co/omar-hatem/modernBERT_classifier_tuned)
...
- AbdelmomenMoula/Weather-GPT-France... (watch for citations and replications)
- BrightHub2/lora-emotional-intelligence-a2de86d6... (watch for citations and replications)
- masaom/32_qwen2_5-7b-agent-baseline_DB-ALF... (watch for citations and replications)
