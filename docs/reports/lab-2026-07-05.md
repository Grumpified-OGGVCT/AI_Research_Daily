...
- Type: dataset
- Research Score: 0.50
- Community Interest: 14,707 downloads, 15 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/mayurisp279/capstone-module1-codellama7b-lora-native)

**Mubarak127/waxal-whisper-large-v3-lug_asr_new-app**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mubarak127/waxal-whisper-large-v3-lug_asr_new-app)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Gugu8/Quark-1)
...
- mayurisp279/capstone-module1-codellama7b-lora-native... (watch for citations and replications)
