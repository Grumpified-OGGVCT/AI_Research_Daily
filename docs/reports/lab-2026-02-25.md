...
- [🤗 View on HuggingFace](https://huggingface.co/GJATT/mms-punjabi-finetuned_unicode)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deqing/llama-300M-v2-original)

**kalsun/functiongemma-270m-it-tool-calling**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kalsun/functiongemma-270m-it-tool-calling)

**masaom/05_qwen2_5-7b-agent-baseline**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/masaom/05_qwen2_5-7b-agent-baseline)

**Warrior025/plant-disease-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Warrior025/plant-disease-model)
...
- [kamaboko2007/llm_advance_015_grpo_alf](https://huggingface.co/kamaboko2007/llm_advance_015_grpo_alf)
...
- GJATT/mms-punjabi-finetuned_unicode... (watch for citations and replications)
- deqing/llama-300M-v2-original... (watch for citations and replications)
- kalsun/functiongemma-270m-it-tool-calling... (watch for citations and replications)
