...
**lingshanCeR/bee-ggww**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lingshanCeR/bee-ggww)
...
- [🤗 View on HuggingFace](https://huggingface.co/laion/swesmith-nl2bash-stack-bugsseq)

**omkarwazulkar/Merged-Llama-3.2-1B-LoRA-HuggingFaceH4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/omkarwazulkar/Merged-Llama-3.2-1B-LoRA-HuggingFaceH4)

**qing-yao/genfreq-finetuned-ep30_seed-42_1e-4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/qing-yao/genfreq-finetuned-ep30_seed-42_1e-4)
