...
**WassyO/qwen3-4b-instruct-dpo-from-sft-4096**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WassyO/qwen3-4b-instruct-dpo-from-sft-4096)

**supertakerin2/waka-gpt**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/supertakerin2/waka-gpt)

**AshleyQu0311/Qwen3-4B-Structured-Conversion-LoRA-v11-J-Precision**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AshleyQu0311/Qwen3-4B-Structured-Conversion-LoRA-v11-J-Precision)

**kowndinya-renduchintala/fineweb-matrix_question_npi_licensor_present-100M-99.99-0.01-gpt2-124M-v0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kowndinya-renduchintala/fineweb-matrix_question_npi_licensor_present-100M-99.99-0.01-gpt2-124M-v0)

**NagaiShun/LLM_01**

- Type: model
- Research Score: 0.40
- Community Interest: 3 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NagaiShun/LLM_01)
