...
**heisengert/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stalking_polished_seahorse**

- Type: model
- Research Score: 0.40
- Community Interest: 332 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/heisengert/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stalking_polished_seahorse)

**lagon20ms/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-pensive_sharp_pigeon**

- Type: model
- Research Score: 0.40
- Community Interest: 312 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lagon20ms/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-pensive_sharp_pigeon)

**chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-tiny_tall_camel**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-tiny_tall_camel)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/PujaSe/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-raging_grazing_chameleon)

**BigFuad/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-webbed_stinky_porpoise**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BigFuad/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-webbed_stinky_porpoise)
...
- heisengert/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stalking... (watch for citations and replications)
- lagon20ms/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-pensive_s... (watch for citations and replications)
- chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-tiny_ta... (watch for citations and replications)
