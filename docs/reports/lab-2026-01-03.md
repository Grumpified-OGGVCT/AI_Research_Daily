...
**inferencerlabs/IQuest-Coder-V1-40B-Loop-Instruct-MLX-6.5bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/IQuest-Coder-V1-40B-Loop-Instruct-MLX-6.5bit)

**titose515/corder-2.5bass**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/titose515/corder-2.5bass)

**kowndinya-renduchintala/fineweb-matrix_question_npi_licensor_present-100M-99-1-gpt2-124M-v0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kowndinya-renduchintala/fineweb-matrix_question_npi_licensor_present-100M-99-1-gpt2-124M-v0)

**canl0we/clasificador-imdb**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/canl0we/clasificador-imdb)

**TSEOsiris/bannerlord-lore-lora-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TSEOsiris/bannerlord-lore-lora-v2)
...
- inferencerlabs/IQuest-Coder-V1-40B-Loop-Instruct-MLX-6.5bit... (watch for citations and replications)
- titose515/corder-2.5bass... (watch for citations and replications)
