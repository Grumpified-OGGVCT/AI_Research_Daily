...
**worthdoing/Phi-3.5-mini-instruct-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/worthdoing/Phi-3.5-mini-instruct-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/worthdoing/DeepSeek-R1-Distill-Qwen-7B-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mustafa99Hafed/LLaMA-3.1-8B-Solana-Audit)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/longtermrisk/Qwen3-1.7B-Base-ftjob-1a226f2e998d)

**TheNinthWave/GloriaGaynorTHIO86**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TheNinthWave/GloriaGaynorTHIO86)
...
- worthdoing/Phi-3.5-mini-instruct-GGUF... (watch for citations and replications)
- worthdoing/DeepSeek-R1-Distill-Qwen-7B-GGUF... (watch for citations and replications)
- Mustafa99Hafed/LLaMA-3.1-8B-Solana-Audit... (watch for citations and replications)
