...
**DevQuasar/cerebras.MiniMax-M2-REAP-172B-A10B-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/cerebras.MiniMax-M2-REAP-172B-A10B-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zeliang0426/QKV_Qwen25-3-full-param-3k)

**a1ex971/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-slithering_whiskered_komodo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/a1ex971/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-slithering_whiskered_komodo)

**AdoCleanCode/MSR-VTT-real-severe_kl08-model-run2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdoCleanCode/MSR-VTT-real-severe_kl08-model-run2)

**KipWill7/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-tropical_rugged_impala**

- Type: model
- Research Score: 0.40
- Community Interest: 414 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/KipWill7/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-tropical_rugged_impala)
