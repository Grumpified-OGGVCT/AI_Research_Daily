...
**yuq-zhou/2026-05-grpo_lenpen_abs-q2-m-7**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yuq-zhou/2026-05-grpo_lenpen_abs-q2-m-7)

**WijewardhanaNT/xnli_en_and_ur_5000_percentage_1_40_LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WijewardhanaNT/xnli_en_and_ur_5000_percentage_1_40_LoRA)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/User01110/cma4-20M)

**enosislabs/AETHER-Mythos-1-1.2B-gguf**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/enosislabs/AETHER-Mythos-1-1.2B-gguf)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/matrixportalx/CyberRealistic)
...
- yuq-zhou/2026-05-grpo_lenpen_abs-q2-m-7... (watch for citations and replications)
- WijewardhanaNT/xnli_en_and_ur_5000_percentage_1_40_LoRA... (watch for citations and replications)
- User01110/cma4-20M... (watch for citations and replications)
