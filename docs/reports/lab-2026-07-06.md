...
**amilab1370/Llama-3.2-1B-new**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/amilab1370/Llama-3.2-1B-new)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/avlp12/Hy3-Alis-MLX-Dynamic)

**MahmoodAnaam/MSP-Audio**

- Type: model
- Research Score: 0.40
- Community Interest: 518 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/MahmoodAnaam/MSP-Audio)

**fpadovani/dan-latn-10mb-after-ppt-shuff-dyck-100mb-ckpt500_seed10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/dan-latn-10mb-after-ppt-shuff-dyck-100mb-ckpt500_seed10)

**ihanif/exp_001_base_vanilla-gguf**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ihanif/exp_001_base_vanilla-gguf)
...
- amilab1370/Llama-3.2-1B-new... (watch for citations and replications)
- avlp12/Hy3-Alis-MLX-Dynamic... (watch for citations and replications)
- MahmoodAnaam/MSP-Audio... (watch for citations and replications)
