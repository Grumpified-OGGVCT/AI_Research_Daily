...
**LLM-course/chess_leonardo_artiles_v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess_leonardo_artiles_v2)

**LLM-course/chess-stonkfish**

- Type: model
- Research Score: 0.40
- Community Interest: 6 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess-stonkfish)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gshasiri/ssn-uncom-unreg-cpt)

**idopinto/qwen3-0.6b-gen-inv-sft-v0-latest-test**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/idopinto/qwen3-0.6b-gen-inv-sft-v0-latest-test)

**AliEsaote/functiongemma-270m-it-simple-tool-calling**

- Type: model
- Research Score: 0.40
- Community Interest: 50 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AliEsaote/functiongemma-270m-it-simple-tool-calling)
...
Today's research firehose scanned **460 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
