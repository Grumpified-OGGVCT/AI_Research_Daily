...
- Type: model
- Research Score: 0.50
- Community Interest: 35,055 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/w-ahmad/Qwen3.5-9B-GGUF-MoQ)

**VladShash/mistral-7B-lean-prover-dpo-deepseek**

- Type: model
- Research Score: 0.50
- Community Interest: 1,958 downloads, 0 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/sukritvemula/WebScrapeAgent-7B-v1)
...
- [🤗 View on HuggingFace](https://huggingface.co/nightmedia/granite-4.1-8b-FlintStones-Stone-Cold-Thinking-mxfp8-mlx)

**Basher17/unsloth-granite-4.1-30b-mlx-4Bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Basher17/unsloth-granite-4.1-30b-mlx-4Bit)
