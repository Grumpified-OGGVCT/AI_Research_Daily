...
- [🤗 View on HuggingFace](https://huggingface.co/sulakhudin/qwen3-14b-soil-full-model)

**vXofi/businessgpt-v13-dpo_v2-qwen3.5-2b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/vXofi/businessgpt-v13-dpo_v2-qwen3.5-2b)
...
**dtran612/TRAIN_SET-phobert-base-vinli-ph**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dtran612/TRAIN_SET-phobert-base-vinli-ph)

**hectocorn-labs/Phibek-4B-v0.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hectocorn-labs/Phibek-4B-v0.1)
...
- [vXofi/businessgpt-v13-dpo_v2-qwen3.5-2b](https://huggingface.co/vXofi/businessgpt-v13-dpo_v2-qwen3.5-2b)
- [dtran612/TRAIN_SET-phobert-base-vinli-ph](https://huggingface.co/dtran612/TRAIN_SET-phobert-base-vinli-ph)
...
- sulakhudin/qwen3-14b-soil-full-model... (watch for citations and replications)
- vXofi/businessgpt-v13-dpo_v2-qwen3.5-2b... (watch for citations and replications)
