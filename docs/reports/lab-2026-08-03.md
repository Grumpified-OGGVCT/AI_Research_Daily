...
- Type: dataset
- Research Score: 0.50
- Community Interest: 55,978 downloads, 15 likes
...
**TigreGotico/opus-mt-tl-en-onnx**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TigreGotico/opus-mt-tl-en-onnx)

**namanadep/Qwen2.5-7B-Manus-Distill**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/namanadep/Qwen2.5-7B-Manus-Distill)

**mlboydaisuke/RF-DETR-Nano-CoreML**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mlboydaisuke/RF-DETR-Nano-CoreML)
...
- fitleech/lm-2b-events-2014... (watch for citations and replications)
- TigreGotico/opus-mt-tl-en-onnx... (watch for citations and replications)
