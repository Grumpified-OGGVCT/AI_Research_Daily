...
- [🤗 View on HuggingFace](https://huggingface.co/abdeljalilELmajjodi/lfm_terjman_test1)

**jasonyandell/zeb-42**

- Type: model
- Research Score: 0.40
- Community Interest: 1,398 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jasonyandell/zeb-42)

**nazhan/gemma-1b-ambg-sejarah-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nazhan/gemma-1b-ambg-sejarah-v2)

**Divanshuverma/llama-legal-finetuned**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Divanshuverma/llama-legal-finetuned)

**lucius-40/new_pyanote**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lucius-40/new_pyanote)
...
- abdeljalilELmajjodi/lfm_terjman_test1... (watch for citations and replications)
- jasonyandell/zeb-42... (watch for citations and replications)
- nazhan/gemma-1b-ambg-sejarah-v2... (watch for citations and replications)
