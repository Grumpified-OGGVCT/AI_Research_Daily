...
- [🤗 View on HuggingFace](https://huggingface.co/ai-and-society/Llama-3.3-70B-Instruct-wanda-unstruct)

**devesh-tiwari/ptt5-brazilian-news-summarizer**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/devesh-tiwari/ptt5-brazilian-news-summarizer)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/helenlu94/NoveltyAdapt-policies)

**lostargon/Tiny-Jev**

- Type: model
- Research Score: 0.40
- Community Interest: 304 downloads, 4 likes
- [🤗 View on HuggingFace](https://huggingface.co/lostargon/Tiny-Jev)

**EliovpAI/Qwen_Image-2.1-MXFP4-Paiton-RDNA4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/EliovpAI/Qwen_Image-2.1-MXFP4-Paiton-RDNA4)
