...
- Type: dataset
- Research Score: 0.50
- Community Interest: 1,759 downloads, 29 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/Guccimam/llama-1-v2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sadda-speech/wav2vec2-espeak-ctc)

**litert-community/Nanbeige4.1-3B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/litert-community/Nanbeige4.1-3B)
...
- Guccimam/llama-1-v2... (watch for citations and replications)
