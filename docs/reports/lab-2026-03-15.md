...
- Type: dataset
- Research Score: 0.50
- Community Interest: 2,565 downloads, 36 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/nvidia/PhysicalAI-Robotics-Kitchen-Sim-Demos)

**reiiham/moodpulse-emotion**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/reiiham/moodpulse-emotion)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deyga/coding-ai-ku)

**Icecraft155/AI_moderation_discord_Class_Learn**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Icecraft155/AI_moderation_discord_Class_Learn)
...
- nvidia/PhysicalAI-Robotics-Kitchen-Sim-Demos... (watch for citations and replications)
- reiiham/moodpulse-emotion... (watch for citations and replications)
- deyga/coding-ai-ku... (watch for citations and replications)
