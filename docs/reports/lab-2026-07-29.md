...
**Hanna-artemis/model_output_kc**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Hanna-artemis/model_output_kc)

**wz7475/qwen2.5-7b-instruct-katcher-med-lora-null-b-evil-principal-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wz7475/qwen2.5-7b-instruct-katcher-med-lora-null-b-evil-principal-v2)
...
**amirsz8203/whisper-small-fa-finetuned**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/amirsz8203/whisper-small-fa-finetuned)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/1jamesthompson1/Qwen3.6-27B-nz-wvs-single_modal-overall)
...
- Hanna-artemis/model_output_kc... (watch for citations and replications)
- wz7475/qwen2.5-7b-instruct-katcher-med-lora-null-b-evil-prin... (watch for citations and replications)
- sullivan1502/base-grpo-round1... (watch for citations and replications)
