...
**acengnew/linear-task-logic-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acengnew/linear-task-logic-model)

**toiar/nllb-finetuned-english-khasi**

- Type: model
- Research Score: 0.40
- Community Interest: 21 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/toiar/nllb-finetuned-english-khasi)

**asthrabala/whisper-medium-finetuned**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/asthrabala/whisper-medium-finetuned)

**acengnew/scenario-action-reasoning-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acengnew/scenario-action-reasoning-model)

**acengnew/short-command-meaning-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acengnew/short-command-meaning-model)
