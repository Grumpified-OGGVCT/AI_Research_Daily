...
- Type: dataset
- Research Score: 0.50
- Community Interest: 126,956 downloads, 16 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/psikosen/canopy-258m-r3)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/psikosen/canopy-258m-r3-v3)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/flaukowski/kannaka-brain-v1-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/khtsly/luau-coder-1.0-preview-small)
...
- psikosen/canopy-258m-r3... (watch for citations and replications)
- psikosen/canopy-258m-r3-v3... (watch for citations and replications)
