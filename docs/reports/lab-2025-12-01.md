...
**fpadovani/candor_sh1_13**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/candor_sh1_13)

**AbstractPhil/geovit-david-beans**

- Type: model
- Research Score: 0.40
- Community Interest: 227 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AbstractPhil/geovit-david-beans)

**amosh83/loralei-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/amosh83/loralei-lora)

**ruchirallen/whisper-oriserve_small_400hrs_new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ruchirallen/whisper-oriserve_small_400hrs_new)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/small-blue/pos-350)
...
- fpadovani/candor_sh1_13... (watch for citations and replications)
- AbstractPhil/geovit-david-beans... (watch for citations and replications)
- amosh83/loralei-lora... (watch for citations and replications)
