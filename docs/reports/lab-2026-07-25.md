...
- Type: model
- Research Score: 0.40
- Community Interest: 1,064 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/syssec-utd/py313-pylingual-v3-mlm)
...
- [🤗 View on HuggingFace](https://huggingface.co/Jolieb/tinyllama-dpo-hallucinating)

**AltronisSG/judgment-qc-gate-gemma-4-e4b-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AltronisSG/judgment-qc-gate-gemma-4-e4b-lora)
...
- Scrappy-Doo/DeepSeek-V4-Pro... (watch for citations and replications)
- syssec-utd/py313-pylingual-v3-mlm... (watch for citations and replications)
- User01110/cma-20M... (watch for citations and replications)
