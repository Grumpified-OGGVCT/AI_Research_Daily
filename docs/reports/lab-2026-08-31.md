...
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/nld-100mb-after-nld_newlexicon_zipf-ckpt500_seed3407)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sachmatkris/agirdi)

**praful1/Qwen-0.6b-nepali-instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 451 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/praful1/Qwen-0.6b-nepali-instruct)
...
- [🤗 View on HuggingFace](https://huggingface.co/ahmetggg/Luck-Qwen3-4b-Code-FineTune)
...
- fpadovani/nld-100mb-after-nld_newlexicon_zipf-ckpt500_seed34... (watch for citations and replications)
- sachmatkris/agirdi... (watch for citations and replications)
- praful1/Qwen-0.6b-nepali-instruct... (watch for citations and replications)
