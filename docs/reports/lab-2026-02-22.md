...
**Rafaelvariavel/Astra-core-3.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Rafaelvariavel/Astra-core-3.1)

**nak-tak225/qwen3-4b-structured-output-lora-sft-advanced-control**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nak-tak225/qwen3-4b-structured-output-lora-sft-advanced-control)

**follmon10/qwen3-4b-structured-output-lora_fol_1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/follmon10/qwen3-4b-structured-output-lora_fol_1)

**kochan13/lora_agentbench_qwen2.5_7b_26022203**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kochan13/lora_agentbench_qwen2.5_7b_26022203)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/cheanus/MinKeNB)
...
- [follmon10/qwen3-4b-structured-output-lora_fol_1](https://huggingface.co/follmon10/qwen3-4b-structured-output-lora_fol_1)
- [Yano/exp-0222-026-realenv-llmtraj-qwen2.5-7b](https://huggingface.co/Yano/exp-0222-026-realenv-llmtraj-qwen2.5-7b)
- [alexalva1234/distilbert-base-uncased-finetuned-cola](https://huggingface.co/alexalva1234/distilbert-base-uncased-finetuned-cola)
...
- Rafaelvariavel/Astra-core-3.1... (watch for citations and replications)
- nak-tak225/qwen3-4b-structured-output-lora-sft-advanced-cont... (watch for citations and replications)
- follmon10/qwen3-4b-structured-output-lora_fol_1... (watch for citations and replications)
