...
- [🤗 View on HuggingFace](https://huggingface.co/Lyon28/caca-50m)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lyon28/caca-10m)

**chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-patterned_sneaky_raccoon**

- Type: model
- Research Score: 0.40
- Community Interest: 437 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-patterned_sneaky_raccoon)

**edademireleda/bert-base-uncased-finetuned-mrpc-run_3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/edademireleda/bert-base-uncased-finetuned-mrpc-run_3)

**ubunator/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-moist_regal_mule**

- Type: model
- Research Score: 0.40
- Community Interest: 399 downloads, 0 likes
