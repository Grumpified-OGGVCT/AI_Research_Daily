...
**NaijaLingo/9javox-9jalingo-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NaijaLingo/9javox-9jalingo-v1)

**AshMrb/qwen3-4b-structured-output-lora_ashv10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AshMrb/qwen3-4b-structured-output-lora_ashv10)

**jessicajames1438/gray-swan-classifier_V3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jessicajames1438/gray-swan-classifier_V3)

**pgsyttch/qwen3-4b-agent-trajectory-lora-0221**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pgsyttch/qwen3-4b-agent-trajectory-lora-0221)

**inferencerlabs/INTELLECT-3.1-MLX-9bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/INTELLECT-3.1-MLX-9bit)
...
- NaijaLingo/9javox-9jalingo-v1... (watch for citations and replications)
- AshMrb/qwen3-4b-structured-output-lora_ashv10... (watch for citations and replications)
- jessicajames1438/gray-swan-classifier_V3... (watch for citations and replications)
