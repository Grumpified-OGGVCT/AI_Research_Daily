...
**HackAfterDark/Carnice-Qwen3.6-MoE-35B-A3B-NVFP4**

- Type: model
- Research Score: 0.40
- Community Interest: 81 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HackAfterDark/Carnice-Qwen3.6-MoE-35B-A3B-NVFP4)
...
- [🤗 View on HuggingFace](https://huggingface.co/TMLR/dORM-qwen)

**Wizcoderr/qwen3-14b-flutter-fused**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Wizcoderr/qwen3-14b-flutter-fused)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TMLR/dPRM-qwen)
...
- HackAfterDark/Carnice-Qwen3.6-MoE-35B-A3B-NVFP4... (watch for citations and replications)
- TMLR/dORM-qwen... (watch for citations and replications)
