...
### 3. TornadoNet: Real-Time Building Damage Detection with Ordinal Supervision

**Authors**: Robinson Umeike et al.  
**Research Score**: 0.86 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: We present TornadoNet, a comprehensive benchmark for automated street-level building damage assessment evaluating how modern real-time object detection architectures and ordinal-aware supervision strategies perform under realistic post-disaster conditions. TornadoNet provides the first controlled be...
...
[📄 Read Paper](https://arxiv.org/abs/2603.11557v1)
...
**The Density of Cross-Persistence Diagrams and Its Applications** (Score: 0.79)

Topological Data Analysis (TDA) provides powerful tools to explore the shape and structure of data through topological features such as clusters, loops, and voids. Persistence diagrams are a cornersto... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.11623v1)
...
**beezu/GLM-4.5-Iceblink-v3-106B-A12B-mlx-qx-mxfp4-mxfp8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/beezu/GLM-4.5-Iceblink-v3-106B-A12B-mlx-qx-mxfp4-mxfp8)

**osirisbrain/OsirisCortex-v7c-MLX**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/osirisbrain/OsirisCortex-v7c-MLX)

**wayyresearch/aetheris**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/wayyresearch/aetheris)

**Shreyash2010/saras-lite**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Shreyash2010/saras-lite)

**xummer/qwen3-8b-gsm8k-lora-ja**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xummer/qwen3-8b-gsm8k-lora-ja)
...
**Papers in this cluster**:
- [Resource-Efficient Iterative LLM-Based NAS with Feedback Memory](https://arxiv.org/abs/2603.12091v1)
- [TornadoNet: Real-Time Building Damage Detection with Ordinal Supervision](https://arxiv.org/abs/2603.11557v1)
- [VisDoT : Enhancing Visual Reasoning through Human-Like Interpretation Grounding and Decomposition of Thought](https://arxiv.org/abs/2603.11631v1)
...
- TornadoNet: Real-Time Building Damage Detection with Ordinal... (watch for citations and replications)
...
**3. TornadoNet: Real-Time Building Damage Detection with Ordinal Supervision** (Score: 0.86) 【breakthrough:3】

*In plain English*: We present TornadoNet, a comprehensive benchmark for automated street-level building damage assessment evaluating how modern real-time object detection architectures and ordinal-aware supervision strategies perform under realistic post-disaster condi...
