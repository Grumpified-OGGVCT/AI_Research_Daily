...
**naver-ellm/functiongemma-270m-it-mobile-actions**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/naver-ellm/functiongemma-270m-it-mobile-actions)
...
- [🤗 View on HuggingFace](https://huggingface.co/PolarisETP/qwen25-3b-peacetalk-magic-v2-merged)

**yufeng1/Apriel-15B-type6-e5-max-alpha0_75**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yufeng1/Apriel-15B-type6-e5-max-alpha0_75)

**tvall43/Qwen3.5-2B-Claude-4.6-Opus-Reasoning-Distilled-heretic-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tvall43/Qwen3.5-2B-Claude-4.6-Opus-Reasoning-Distilled-heretic-v2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/davidemodolo/alphamon)
...
- [naver-ellm/functiongemma-270m-it-mobile-actions](https://huggingface.co/naver-ellm/functiongemma-270m-it-mobile-actions)
- [hadangvu/pkd-finbert-student](https://huggingface.co/hadangvu/pkd-finbert-student)
...
- naver-ellm/functiongemma-270m-it-mobile-actions... (watch for citations and replications)
- PolarisETP/qwen25-3b-peacetalk-magic-v2-merged... (watch for citations and replications)
- yufeng1/Apriel-15B-type6-e5-max-alpha0_75... (watch for citations and replications)
