...
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/jpn-100mb-after-wc-uniform-oldlex-eng-ckpt500_seed10_seed10)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/voice-box/shakespeare)

**leomaurodesenv/electra-base-discriminator-jailbreakv-28k-augmented**

- Type: model
- Research Score: 0.40
- Community Interest: 69 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/leomaurodesenv/electra-base-discriminator-jailbreakv-28k-augmented)

**kilian-group/KBevo-Qwen3-4B-SFT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kilian-group/KBevo-Qwen3-4B-SFT)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/nld-100mb-after-nld_heavy_zipf_fix_zijn-ckpt500_seed3407_seed3407)
...
- fpadovani/jpn-100mb-after-wc-uniform-oldlex-eng-ckpt500_seed... (watch for citations and replications)
- voice-box/shakespeare... (watch for citations and replications)
- leomaurodesenv/electra-base-discriminator-jailbreakv-28k-aug... (watch for citations and replications)
