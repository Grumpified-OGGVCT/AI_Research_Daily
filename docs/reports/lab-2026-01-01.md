...
- Type: dataset
- Research Score: 0.50
- Community Interest: 48,726 downloads, 8 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/allenai/dolma3_longmino_pool)
...
**asparius/Qwen2.5-7B-Instruct-SPO-1ep-iter16**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/asparius/Qwen2.5-7B-Instruct-SPO-1ep-iter16)
...
- allenai/dolma3_longmino_pool... (watch for citations and replications)
- swadeshb/Llama-3.2-3B-Instruct-AMPO-V1-6... (watch for citations and replications)
- asparius/Qwen2.5-7B-Instruct-SPO-1ep-iter16... (watch for citations and replications)
