...
- [🤗 View on HuggingFace](https://huggingface.co/gatilin/sparklm-31m-tinystories)
...
- [🤗 View on HuggingFace](https://huggingface.co/slevinw/Qwen3.8-27B-RAM-13GB-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hudlow/gemma-3-270m-mlx-4Bit)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/matrixportalx/UltraRealisticByStableYogi_v3)

**ornith-ai/Ornith-1.5-397B-FP8**

- Type: model
- Research Score: 0.40
- Community Interest: 12,037 downloads, 7 likes
- [🤗 View on HuggingFace](https://huggingface.co/ornith-ai/Ornith-1.5-397B-FP8)
...
- gatilin/sparklm-31m-tinystories... (watch for citations and replications)
- slevinw/Qwen3.8-27B-RAM-13GB-GGUF... (watch for citations and replications)
- hudlow/gemma-3-270m-mlx-4Bit... (watch for citations and replications)
