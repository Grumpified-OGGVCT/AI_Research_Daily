...
**dronefreak/exdark-rfdetr-small**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dronefreak/exdark-rfdetr-small)

**just1nseo/olmo3-7b-think-if-rlvr-constraint-only-pp0-8k**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/just1nseo/olmo3-7b-think-if-rlvr-constraint-only-pp0-8k)

**unsloth/ideogram-4-fp8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/unsloth/ideogram-4-fp8)

**unsloth/ideogram-4-nf4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/unsloth/ideogram-4-nf4)

**sulaimank/w2vbert-lingala-sd2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sulaimank/w2vbert-lingala-sd2)
