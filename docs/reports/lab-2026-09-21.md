...
- [🤗 View on HuggingFace](https://huggingface.co/nilamgaichor/text_classification_senti_analysis)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Zrald/zralddeepseekv4.1)

**thisisisheanesu/morena-tools-gguf**

- Type: model
- Research Score: 0.40
- Community Interest: 52 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/thisisisheanesu/morena-tools-gguf)

**cellsheet/Anima-Turbo-MLX-Serve**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/cellsheet/Anima-Turbo-MLX-Serve)

**cellsheet/Anima-Base-MLX-Serve**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/cellsheet/Anima-Base-MLX-Serve)
...
- nilamgaichor/text_classification_senti_analysis... (watch for citations and replications)
- Zrald/zralddeepseekv4.1... (watch for citations and replications)
- thisisisheanesu/morena-tools-gguf... (watch for citations and replications)
