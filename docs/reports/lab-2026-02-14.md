...
**ShacharNar/qwen2.5_coder_3b_sqlfuse_probgate_tsql_improved_prompt_reasoning_only_answerable_delimeters_eos**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ShacharNar/qwen2.5_coder_3b_sqlfuse_probgate_tsql_improved_prompt_reasoning_only_answerable_delimeters_eos)

**mazesmazes/tiny-audio-lm-stage1**

- Type: model
- Research Score: 0.40
- Community Interest: 85 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mazesmazes/tiny-audio-lm-stage1)

**AshleyQu0311/Qwen3-4B-Structured-Conversion-LoRA-v4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AshleyQu0311/Qwen3-4B-Structured-Conversion-LoRA-v4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/RumuH/dia-pangu-bin)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Tinker-Stack/Nemotron-3-Nano-30B-A3B-IQ4_XS-GGUF)
