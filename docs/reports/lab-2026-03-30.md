...
**AdoCleanCode/Fakeddit_real_moderate**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdoCleanCode/Fakeddit_real_moderate)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ceselder/cot-oracle-paper-ablation-ours-3layers-onpolicy-lens-only)
...
- [🤗 View on HuggingFace](https://huggingface.co/Jendersen/t5-small-finetuned-welsh-breton-kernewek-32)

**dv347/qwen-B1minus_v3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dv347/qwen-B1minus_v3)

**infohound/cogito-14b-voice-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/infohound/cogito-14b-voice-GGUF)
...
- AdoCleanCode/Fakeddit_real_moderate... (watch for citations and replications)
- ceselder/cot-oracle-paper-ablation-ours-3layers-onpolicy-len... (watch for citations and replications)
- Jendersen/t5-small-finetuned-welsh-breton-kernewek-32... (watch for citations and replications)
