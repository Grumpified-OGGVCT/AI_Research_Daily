...
**ahmiershadowman/qwen3-4b-pretrain-stream**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ahmiershadowman/qwen3-4b-pretrain-stream)

**houamrha/whisper-large-v2-test-checkpoint**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/houamrha/whisper-large-v2-test-checkpoint)

**jainishaan107/gpt2-medium-ppo-full**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jainishaan107/gpt2-medium-ppo-full)

**OguraHiroyuki/dpo-qwen-cot-mergedv7**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/OguraHiroyuki/dpo-qwen-cot-mergedv7)
...
- [🤗 View on HuggingFace](https://huggingface.co/deqing/llama-300M-v2-trigram)
