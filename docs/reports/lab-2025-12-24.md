...
**semihipekk/competition-law-stage2-susp-vs-violation-v2_llama**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/semihipekk/competition-law-stage2-susp-vs-violation-v2_llama)

**je-suis-tm/pachu_torres_style_lora_flux_nf4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/je-suis-tm/pachu_torres_style_lora_flux_nf4)

**fruzti/wav2vec2-base-100k-voxpopuli-finetuned-gtzan**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fruzti/wav2vec2-base-100k-voxpopuli-finetuned-gtzan)

**westwind027/myemoji-gemma-3-270m-it**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/westwind027/myemoji-gemma-3-270m-it)

**Yuvrajg2107/deberta-v3-hybrid-detector_1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Yuvrajg2107/deberta-v3-hybrid-detector_1)
