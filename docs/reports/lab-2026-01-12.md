...
**Aakifkhan/mistral-7b-instruct-adcopy-v0.3-bnb-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Aakifkhan/mistral-7b-instruct-adcopy-v0.3-bnb-4bit)

**felixZzz/Qwen3-14B-Base-math-bf16-step250**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/felixZzz/Qwen3-14B-Base-math-bf16-step250)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/devmrv/last)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Oluwaferanmiii/codet5p-220m-pytest-edge-generator)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/laurent-maille/EuroLLM-22B-Instruct-2512-INT8)
...
- Aakifkhan/mistral-7b-instruct-adcopy-v0.3-bnb-4bit... (watch for citations and replications)
- felixZzz/Qwen3-14B-Base-math-bf16-step250... (watch for citations and replications)
- devmrv/last... (watch for citations and replications)
