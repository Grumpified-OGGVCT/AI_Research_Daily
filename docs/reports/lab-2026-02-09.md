...
**FlimsyFox/Llama-3.2-3B-Fluxed-uncensored-v0.1-4bit-rk3588-1.1.2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/FlimsyFox/Llama-3.2-3B-Fluxed-uncensored-v0.1-4bit-rk3588-1.1.2)

**SemanticAlignment/Mistral-v0.1-Italian-SAVA-instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SemanticAlignment/Mistral-v0.1-Italian-SAVA-instruct)

**MSey/semisynthetic_annotation_Lama32_on_Llama70b_no_RAG**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MSey/semisynthetic_annotation_Lama32_on_Llama70b_no_RAG)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SemanticAlignment/Mistral-v0.1-Italian-LAPT-instruct)

**Kyoung1229/chessi-0.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kyoung1229/chessi-0.1)
...
- FlimsyFox/Llama-3.2-3B-Fluxed-uncensored-v0.1-4bit-rk3588-1.... (watch for citations and replications)
- SemanticAlignment/Mistral-v0.1-Italian-SAVA-instruct... (watch for citations and replications)
- MSey/semisynthetic_annotation_Lama32_on_Llama70b_no_RAG... (watch for citations and replications)
