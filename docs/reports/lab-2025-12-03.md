...
**marcelovidigal/smollm3-3b-sft-finetuned-jobs-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/marcelovidigal/smollm3-3b-sft-finetuned-jobs-v2)
...
- [🤗 View on HuggingFace](https://huggingface.co/mlx-community/DeepSeek-V3.2-Speciale-4bit)
