...
**Junyi-tao/models-seqs_return_2nd-every16-stage1-step928646-tokens3896B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Junyi-tao/models-seqs_return_2nd-every16-stage1-step928646-tokens3896B)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/eekay/gemma-2b-it-lion-numbers-ft-exp)
...
**puppyAhn/koelectra-lang6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/puppyAhn/koelectra-lang6)
...
- Junyi-tao/models-seqs_return_2nd-every16-stage1-step928646-t... (watch for citations and replications)
- eekay/gemma-2b-it-lion-numbers-ft-exp... (watch for citations and replications)
- web34ever/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-yawning_g... (watch for citations and replications)
