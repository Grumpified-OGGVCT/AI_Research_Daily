...
**activeDap/Qwen2-1.5B_hh_helpful**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/activeDap/Qwen2-1.5B_hh_helpful)

**craa/exceptions_exp2_swap_0.3_last_to_carry_1032**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/craa/exceptions_exp2_swap_0.3_last_to_carry_1032)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/juanml82/Huihui-Qwen3-Next-80B-A3B-Thinking-abliterated-gguf)
