...
- [🤗 View on HuggingFace](https://huggingface.co/anlord/Qwen3.5-0.8B-Abliterated-GGUF)

**wckwan/Alfworld-Olmo3-7B-Adaptive-Midpoint**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wckwan/Alfworld-Olmo3-7B-Adaptive-Midpoint)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/CharlieLLL/Qwen3-4B-BrowseComp-Worker-SFT-0915)

**canada-quant/GLM-5.3-Flash-DFlash2-E**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/canada-quant/GLM-5.3-Flash-DFlash2-E)
...
- anlord/Qwen3.5-0.8B-Abliterated-GGUF... (watch for citations and replications)
- wckwan/Alfworld-Olmo3-7B-Adaptive-Midpoint... (watch for citations and replications)
- CharlieLLL/Qwen3-4B-BrowseComp-Worker-SFT-0915... (watch for citations and replications)
