...
- [🤗 View on HuggingFace](https://huggingface.co/y3chnx/clave-sft)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/edbeeching/Qwen3-4B-Thinking-2507-SFT-tr5)

**leonard-milo/Qwen3.5-2B-SFT-AutoConv-InstagramChat-Stupid**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/leonard-milo/Qwen3.5-2B-SFT-AutoConv-InstagramChat-Stupid)

**ccui46/qwen3_8b_hw_sft_hazardworld_per_chunk_act_q3_4500**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ccui46/qwen3_8b_hw_sft_hazardworld_per_chunk_act_q3_4500)

**leonard-milo/Qwen3.5-2B-SFT-AutoConv-InstagramChat-Smart**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/leonard-milo/Qwen3.5-2B-SFT-AutoConv-InstagramChat-Smart)
...
- y3chnx/clave-sft... (watch for citations and replications)
- edbeeching/Qwen3-4B-Thinking-2507-SFT-tr5... (watch for citations and replications)
- leonard-milo/Qwen3.5-2B-SFT-AutoConv-InstagramChat-Stupid... (watch for citations and replications)
