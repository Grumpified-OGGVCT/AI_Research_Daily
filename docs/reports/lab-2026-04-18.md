...
- **Implementation Watch**: 26 new models/datasets on HuggingFace
...
- [🤗 View on HuggingFace](https://huggingface.co/KULIANLEN/qwen3-4b-35b-prompt-new_solver_aux_v5)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TaimurShaikh/qwen1.5-1.8b-sft)

**GODsStrongestSoldier/Opus4.7-GODsGhost-Codex-4B.GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/GODsStrongestSoldier/Opus4.7-GODsGhost-Codex-4B.GGUF)

**jacob9706/Qwen3.6-35B-A3B-QOR-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jacob9706/Qwen3.6-35B-A3B-QOR-4bit)
...
- **Total Papers Scanned**: 226
- **High-Relevance Papers**: 226
