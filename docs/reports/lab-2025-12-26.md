...
**subhrajit-mohanty/functiongemma-270m-it-simple-tool-calling**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/subhrajit-mohanty/functiongemma-270m-it-simple-tool-calling)

**tiagoft/multiberts-seed_5_imdb_finetuned_epoch_8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tiagoft/multiberts-seed_5_imdb_finetuned_epoch_8)

**inferencerlabs/MiniMax-M2.1-MLX-6.5bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/MiniMax-M2.1-MLX-6.5bit)

**chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-tiny_secretive_gibbon**

- Type: model
- Research Score: 0.40
- Community Interest: 662 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-tiny_secretive_gibbon)

**valid-name1/Qwen3-0.6B-Q4_K_M-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/valid-name1/Qwen3-0.6B-Q4_K_M-GGUF)
...
- **Total Papers Scanned**: 170
- **High-Relevance Papers**: 170
