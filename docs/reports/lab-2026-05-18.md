...
- **Implementation Watch**: 32 new models/datasets on HuggingFace
...
**ASomeoneWhoInterestedWithAI/LookThem_STL-10**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/ASomeoneWhoInterestedWithAI/LookThem_STL-10)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 30,189 downloads, 317 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**mradermacher/gemma-4-Ortenzya-The-Creative-Wordsmith-31B-it-uncensored-heretic-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/gemma-4-Ortenzya-The-Creative-Wordsmith-31B-it-uncensored-heretic-i1-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/arkoda/arkoda-70b-v2-merged)

**mk48/gemma-2b-it-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mk48/gemma-2b-it-lora)
...
- ASomeoneWhoInterestedWithAI/LookThem_STL-10... (watch for citations and replications)
- open-index/hacker-news... (watch for citations and replications)
- mradermacher/gemma-4-Ortenzya-The-Creative-Wordsmith-31B-it-... (watch for citations and replications)
...
- **Total Papers Scanned**: 32
- **High-Relevance Papers**: 32
