...
- [🤗 View on HuggingFace](https://huggingface.co/CyFalcon/truthguard-bert)

**EvgenAnt/phishing-email-detection-distilbert_v2.4.1-ONNX**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/EvgenAnt/phishing-email-detection-distilbert_v2.4.1-ONNX)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HFCK99/Qwen3.8-27B-AEON-ULTIMATE-UNCENSORED-BF16)
...
- [🤗 View on HuggingFace](https://huggingface.co/Joakimpalm-Zen/NVIDIA-Nemotron-Nano-9B-v2-Q8_0-GGUF)
...
Today's research firehose scanned **362 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
