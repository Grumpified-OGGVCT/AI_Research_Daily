...
**moroqq/qwen3-4b-agent-trajectory-lora_rev33**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/moroqq/qwen3-4b-agent-trajectory-lora_rev33)

**kochan13/lora_agentbench_qwen3_7b_26022103**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kochan13/lora_agentbench_qwen3_7b_26022103)

**rcdoug03/sd35-lora-none-none-Georges_Braque**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rcdoug03/sd35-lora-none-none-Georges_Braque)

**sk0118/deepseek-r1-cyber-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sk0118/deepseek-r1-cyber-lora)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/takatuki56/test06)
...
- moroqq/qwen3-4b-agent-trajectory-lora_rev33... (watch for citations and replications)
- kochan13/lora_agentbench_qwen3_7b_26022103... (watch for citations and replications)
- rcdoug03/sd35-lora-none-none-Georges_Braque... (watch for citations and replications)
