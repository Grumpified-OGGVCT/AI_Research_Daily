...
- [🤗 View on HuggingFace](https://huggingface.co/PYTHAI/mindXtrain)
...
- [🤗 View on HuggingFace](https://huggingface.co/spst01/Qwen2.5-0.5B-Sukshma)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/GoodnotesIT/nemotron-3.5-asr-streaming-multilingual-0.6b-litert-fp16)
...
**d4rkninja/DarkNinja-LFM2.5-1.2B-Marketing-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/d4rkninja/DarkNinja-LFM2.5-1.2B-Marketing-GGUF)
