...
- **Implementation Watch**: 33 new models/datasets on HuggingFace
...
- [🤗 View on HuggingFace](https://huggingface.co/ryowatanabe240215/qwen3-4b-structured-output-lora_ver10-2_merge_dpo)

**orangehat-jp/dpo-qwen-cot-merged-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/orangehat-jp/dpo-qwen-cot-merged-v2)

**nphSi/Z-Image-Lora**

- Type: model
- Research Score: 0.40
- Community Interest: 100,037 downloads, 36 likes
- [🤗 View on HuggingFace](https://huggingface.co/nphSi/Z-Image-Lora)

**K-WATANABE159/qwen3-4b-baseline-ep2-lr5e6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/K-WATANABE159/qwen3-4b-baseline-ep2-lr5e6)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aolans/Qwen2.5-7B-Instruct-SDFT-2ep-fp16)
...
- ryowatanabe240215/qwen3-4b-structured-output-lora_ver10-2_me... (watch for citations and replications)
- orangehat-jp/dpo-qwen-cot-merged-v2... (watch for citations and replications)
- nphSi/Z-Image-Lora... (watch for citations and replications)
...
- **Total Papers Scanned**: 33
- **High-Relevance Papers**: 33
