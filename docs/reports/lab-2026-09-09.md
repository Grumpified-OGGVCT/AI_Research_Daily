...
**bot-lab-21/GLM-5.3-EXL3-3.2bpw-Pollard-Smooth**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/bot-lab-21/GLM-5.3-EXL3-3.2bpw-Pollard-Smooth)

**Jordine/patina3-v3_americac-am_sft_s0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jordine/patina3-v3_americac-am_sft_s0)
...
- mj-kang/GLM-5.3-EXL3-3.0bpw-TP3... (watch for citations and replications)
- bot-lab-21/GLM-5.3-EXL3-3.2bpw-Pollard-Smooth... (watch for citations and replications)
