...
**ngocminh06/qwen3-asr-nonverbal-merged-3500**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ngocminh06/qwen3-asr-nonverbal-merged-3500)

**ddh0/gemma-4-it-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 43,311 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ddh0/gemma-4-it-GGUF)

**g4me/QwenRolina3-Base-LR1e5-b32g2gc8-ck2048-order-batch**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/g4me/QwenRolina3-Base-LR1e5-b32g2gc8-ck2048-order-batch)

**takehika/wav2vec2-ja-cv25-reazon-mixed**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/takehika/wav2vec2-ja-cv25-reazon-mixed)
...
- ngocminh06/qwen3-asr-nonverbal-merged-3500... (watch for citations and replications)
- ddh0/gemma-4-it-GGUF... (watch for citations and replications)
