...
**israel/hausa_llama3.2-1b_dpo_rgemma-3-27b-it**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/israel/hausa_llama3.2-1b_dpo_rgemma-3-27b-it)

**chimbiwide/cxr-normal-dreambooth**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chimbiwide/cxr-normal-dreambooth)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ali-elganzory/Qwen2.5-1.5B-SFT-Tulu3-decontaminated)

**Thrillcrazyer/Qwen-7B_Open_GSPO**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Thrillcrazyer/Qwen-7B_Open_GSPO)
...
- [LLM-course/chess-sam](https://huggingface.co/LLM-course/chess-sam)
- [LLM-course/spirow_chess_v0](https://huggingface.co/LLM-course/spirow_chess_v0)
- [naveen-27022005/distilbert-email-category-classifier](https://huggingface.co/naveen-27022005/distilbert-email-category-classifier)
- [LLM-course/chess-submission-v2-MDaytek](https://huggingface.co/LLM-course/chess-submission-v2-MDaytek)
- [arthurbittencourt/january-llm_paraphrase-xlm-roberta_1to2-twitter_topics_1_a-fold9](https://huggingface.co/arthurbittencourt/january-llm_paraphrase-xlm-roberta_1to2-twitter_topics_1_a-fold9)
...
- israel/hausa_llama3.2-1b_dpo_rgemma-3-27b-it... (watch for citations and replications)
- chimbiwide/cxr-normal-dreambooth... (watch for citations and replications)
