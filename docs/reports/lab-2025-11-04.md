...
**Hanan-Alnakhal/my-Answering-Question-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Hanan-Alnakhal/my-Answering-Question-model)

**oberbics/llama-3.1-newspaper-arguments-memi_2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/oberbics/llama-3.1-newspaper-arguments-memi_2)

**noctrex/Qwen3-Coder-480B-A35B-Instruct-1M-MXFP4_MOE-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/noctrex/Qwen3-Coder-480B-A35B-Instruct-1M-MXFP4_MOE-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MyrruSherd/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-nasty_dappled_cheetah)

**choiqs/Qwen3-1.7B-if-bsz128-ts750-ranking-skywork8b-seed42-lr1e-6-warmup10-checkpoint375**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/choiqs/Qwen3-1.7B-if-bsz128-ts750-ranking-skywork8b-seed42-lr1e-6-warmup10-checkpoint375)
...
- Hanan-Alnakhal/my-Answering-Question-model... (watch for citations and replications)
- oberbics/llama-3.1-newspaper-arguments-memi_2... (watch for citations and replications)
- noctrex/Qwen3-Coder-480B-A35B-Instruct-1M-MXFP4_MOE-GGUF... (watch for citations and replications)
