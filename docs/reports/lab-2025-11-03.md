...
**oberbics/llama-8B-argument_mining_V6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/oberbics/llama-8B-argument_mining_V6)

**tinnguyen16/Qwen3-0.6B-Gensyn-Swarm-invisible_whiskered_kiwi**

- Type: model
- Research Score: 0.40
- Community Interest: 599 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tinnguyen16/Qwen3-0.6B-Gensyn-Swarm-invisible_whiskered_kiwi)

**sabaridsnfuji/Qwen3-8B-tamil-16bit-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sabaridsnfuji/Qwen3-8B-tamil-16bit-Instruct)

**kostdima/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-invisible_climbing_peacock**

- Type: model
- Research Score: 0.40
- Community Interest: 252 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kostdima/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-invisible_climbing_peacock)

**contemmcm/1e22b46b8eddf5a05a4230f8924cd07c**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/contemmcm/1e22b46b8eddf5a05a4230f8924cd07c)
...
- oberbics/llama-8B-argument_mining_V6... (watch for citations and replications)
- tinnguyen16/Qwen3-0.6B-Gensyn-Swarm-invisible_whiskered_kiwi... (watch for citations and replications)
- sabaridsnfuji/Qwen3-8B-tamil-16bit-Instruct... (watch for citations and replications)
