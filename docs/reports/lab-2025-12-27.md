...
- [🤗 View on HuggingFace](https://huggingface.co/yapwithai/jinx-qwen3-14B-trt-awq)

**tiagoft/multiberts-seed_7_sst2_finetuned_final**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tiagoft/multiberts-seed_7_sst2_finetuned_final)

**tiagoft/multiberts-seed_7_sst2_finetuned_epoch_12**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tiagoft/multiberts-seed_7_sst2_finetuned_epoch_12)

**xiwenc1/OpenRS-dra_GRPO-qwen2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xiwenc1/OpenRS-dra_GRPO-qwen2)

**chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-graceful_slender_toucan**

- Type: model
- Research Score: 0.40
- Community Interest: 366 downloads, 0 likes
...
- [tiagoft/multiberts-seed_7_sst2_finetuned_final](https://huggingface.co/tiagoft/multiberts-seed_7_sst2_finetuned_final)
- [tiagoft/multiberts-seed_7_sst2_finetuned_epoch_12](https://huggingface.co/tiagoft/multiberts-seed_7_sst2_finetuned_epoch_12)
...
- yapwithai/jinx-qwen3-14B-trt-awq... (watch for citations and replications)
- tiagoft/multiberts-seed_7_sst2_finetuned_final... (watch for citations and replications)
- tiagoft/multiberts-seed_7_sst2_finetuned_epoch_12... (watch for citations and replications)
