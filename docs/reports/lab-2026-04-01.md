...
- [🤗 View on HuggingFace](https://huggingface.co/OmarMaqousi/distilbert-emotion-model-v2)

**narcissablack/dsdba-efficientnet-b4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/narcissablack/dsdba-efficientnet-b4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/alrope/Qwen2.5-7B-Instruct-countdown-sos)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Vortex5/Celestial-Queen-12B)

**promotion/helpfulness_adapter**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/promotion/helpfulness_adapter)
...
- OmarMaqousi/distilbert-emotion-model-v2... (watch for citations and replications)
- narcissablack/dsdba-efficientnet-b4... (watch for citations and replications)
- alrope/Qwen2.5-7B-Instruct-countdown-sos... (watch for citations and replications)
