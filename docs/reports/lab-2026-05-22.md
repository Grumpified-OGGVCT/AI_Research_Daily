...
**gguk2on/qwen2.5-7B-rlar_g8_b0384_math_0.40_v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gguk2on/qwen2.5-7B-rlar_g8_b0384_math_0.40_v2)

**veeru2706/vritlellm-70b-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/veeru2706/vritlellm-70b-v2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/brine7302/gemma-4-E2B-abliterated-litert-lm)

**IsraInfo2004/drone-detection-yolov11**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IsraInfo2004/drone-detection-yolov11)

**Evilcarbon/DeepSeek-V4-Pro**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Evilcarbon/DeepSeek-V4-Pro)
...
- gguk2on/qwen2.5-7B-rlar_g8_b0384_math_0.40_v2... (watch for citations and replications)
- veeru2706/vritlellm-70b-v2... (watch for citations and replications)
- brine7302/gemma-4-E2B-abliterated-litert-lm... (watch for citations and replications)
