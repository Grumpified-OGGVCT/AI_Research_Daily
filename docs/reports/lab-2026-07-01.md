...
**MohammedSohail111/shroom-paligemma**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MohammedSohail111/shroom-paligemma)

**anusasaha/medgemma-ner-diagonsis-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/anusasaha/medgemma-ner-diagonsis-lora)

**nwzjk/MiniMax-M3-NVFP4-Duplicated**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nwzjk/MiniMax-M3-NVFP4-Duplicated)

**petra345/MyAwesomeModel-EfficientRelease-TestRepo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/petra345/MyAwesomeModel-EfficientRelease-TestRepo)

**fpadovani/rus-cyrl-10mb-100mb_seed10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/rus-cyrl-10mb-100mb_seed10)
