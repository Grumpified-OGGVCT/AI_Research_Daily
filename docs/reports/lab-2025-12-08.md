...
**nhannguyen2730/gemme3-4b-qlora-tc**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nhannguyen2730/gemme3-4b-qlora-tc)

**rjcg/gemma-dolly-afinado-hf**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rjcg/gemma-dolly-afinado-hf)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/DeepSeek-V3.2-Speciale-MLX-4.8bit)
...
- [rishabhrj11/distillspec-smollm-cnn-b5](https://huggingface.co/rishabhrj11/distillspec-smollm-cnn-b5)
- [Ksjsjjdj/Tiny-LLM-Z-V6](https://huggingface.co/Ksjsjjdj/Tiny-LLM-Z-V6)
...
- nhannguyen2730/gemme3-4b-qlora-tc... (watch for citations and replications)
- rjcg/gemma-dolly-afinado-hf... (watch for citations and replications)
- kaushalvasoya/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-chatt... (watch for citations and replications)
