...
- Type: model
- Research Score: 0.40
- Community Interest: 1,765 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deqing/mamba2-300M-v5-mamba2)

**Solenopsisbot/solace-alpha**

- Type: model
- Research Score: 0.40
- Community Interest: 35 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Solenopsisbot/solace-alpha)
...
- [🤗 View on HuggingFace](https://huggingface.co/furproxy/35b-2)

**NoahShen/id-0001-beear-519**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NoahShen/id-0001-beear-519)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ChuGyouk/F_R19_1_T1)
...
- deqing/mamba2-300M-v5-mamba2... (watch for citations and replications)
- Solenopsisbot/solace-alpha... (watch for citations and replications)
- furproxy/35b-2... (watch for citations and replications)
