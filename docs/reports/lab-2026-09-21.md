...
- Type: model
- Research Score: 0.50
- Community Interest: 1,251 downloads, 4 likes
- [🤗 View on HuggingFace](https://huggingface.co/IsValorum/Occamy-1.0-APEX-I-MiniPlus-V2.1-Abliterated-GGUF)

**IsValorum/Apodex-1.1-mini-APEX-I-MiniPlus-V2.1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,098 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IsValorum/Apodex-1.1-mini-APEX-I-MiniPlus-V2.1-GGUF)
...
- [🤗 View on HuggingFace](https://huggingface.co/prakharprasad/Qwen3.8-27B-Uncensored-GGUF)

**IsValorum/Iris-mini-APEX-I-MiniPlus-V2.1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,069 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IsValorum/Iris-mini-APEX-I-MiniPlus-V2.1-GGUF)

**IsValorum/XYZ-Aquila-mini-APEX-I-MiniPlus-V2.1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,410 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IsValorum/XYZ-Aquila-mini-APEX-I-MiniPlus-V2.1-GGUF)
...
- IsValorum/Occamy-1.0-APEX-I-MiniPlus-V2.1-Abliterated-GGUF... (watch for citations and replications)
- IsValorum/Apodex-1.1-mini-APEX-I-MiniPlus-V2.1-GGUF... (watch for citations and replications)
- prakharprasad/Qwen3.8-27B-Uncensored-GGUF... (watch for citations and replications)
