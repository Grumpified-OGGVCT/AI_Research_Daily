...
**pruning/sn38-v11-3-2**

- Type: model
- Research Score: 0.40
- Community Interest: 1,843 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pruning/sn38-v11-3-2)

**pruning/sn38-v11-3-1**

- Type: model
- Research Score: 0.40
- Community Interest: 1,856 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pruning/sn38-v11-3-1)

**theonegareth/FakeNewsDetector**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/theonegareth/FakeNewsDetector)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tcclaviger/Qwen3-Coder-42B-A3B-Instruct-TOTAL-RECALL-MASTER-CODER-M-512k-ctx-W4A16)
