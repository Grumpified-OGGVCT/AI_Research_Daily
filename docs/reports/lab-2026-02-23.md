...
**dv347/deberta-v3-base_smcalflow-classifier_20**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dv347/deberta-v3-base_smcalflow-classifier_20)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gperdrizet/CIFAR10)

**Ba2han/muon-kumru_test**

- Type: model
- Research Score: 0.40
- Community Interest: 59 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ba2han/muon-kumru_test)

**mradermacher/MiniMax-M2.5-REAP-172B-A10B-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,756 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/MiniMax-M2.5-REAP-172B-A10B-i1-GGUF)

**ShogoMu/qwen25_7b_lora_agentbench_v3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ShogoMu/qwen25_7b_lora_agentbench_v3)
...
- [dv347/deberta-v3-base_smcalflow-classifier_20](https://huggingface.co/dv347/deberta-v3-base_smcalflow-classifier_20)
- [chaechae7/FLUX.2-dev-transformer-textfp8-runtime-modular-v3](https://huggingface.co/chaechae7/FLUX.2-dev-transformer-textfp8-runtime-modular-v3)
...
- dv347/deberta-v3-base_smcalflow-classifier_20... (watch for citations and replications)
- gperdrizet/CIFAR10... (watch for citations and replications)
- Ba2han/muon-kumru_test... (watch for citations and replications)
