...
- [🤗 View on HuggingFace](https://huggingface.co/Readidno/anime.mili)

**uberkie/qwen3-4B-self-thinking_4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 1,111 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/uberkie/qwen3-4B-self-thinking_4bit)
...
**nokolora/ffxiv-lumull-and-eyaney**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nokolora/ffxiv-lumull-and-eyaney)

**deqing/llama-300M-v5-window_2**

- Type: model
- Research Score: 0.40
- Community Interest: 4,494 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deqing/llama-300M-v5-window_2)
...
- [C-L-V/PsyDefDetect_roberta-base_merged_lr-5](https://huggingface.co/C-L-V/PsyDefDetect_roberta-base_merged_lr-5)
- [Rajdeep2k/aiagent-classify-bertbase-uncased82](https://huggingface.co/Rajdeep2k/aiagent-classify-bertbase-uncased82)
- [bmnzyb/CampGPT_X](https://huggingface.co/bmnzyb/CampGPT_X)
...
- Readidno/anime.mili... (watch for citations and replications)
- uberkie/qwen3-4B-self-thinking_4bit... (watch for citations and replications)
- piyazon/ASR-cv-corpus-ug-24... (watch for citations and replications)
