...
- [🤗 View on HuggingFace](https://huggingface.co/submarat/gpt2-small-fineweb-edu-10b-dpo)

**submarat/gpt2-small-fineweb-edu-10b-sft**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/submarat/gpt2-small-fineweb-edu-10b-sft)

**huggingface/DEH-image-scan-data**

- Type: dataset
- Research Score: 0.50
- Community Interest: 49,797 downloads, 15 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/DEH-image-scan-data)

**zjhhhh/7b_rlcf_worst_gap_0.17_iter1_step_201**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zjhhhh/7b_rlcf_worst_gap_0.17_iter1_step_201)

**MikCil/IOL-AI-Qwen35-9B-IT-LoRA-Direct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MikCil/IOL-AI-Qwen35-9B-IT-LoRA-Direct)
