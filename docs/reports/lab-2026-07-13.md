...
- Type: dataset
- Research Score: 0.50
- Community Interest: 27,341 downloads, 15 likes
...
- Type: dataset
- Research Score: 0.50
- Community Interest: 20,490 downloads, 332 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/EnzGamers/ABCDAI-R1-1.5b-SFT)
...
- [🤗 View on HuggingFace](https://huggingface.co/LoganLeGrand/Phi-4-mini-instruct-ShopRAG)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/nld-latn-100mb-after-ppt-shuff-dyck-100mb-ckpt500_seed10)
...
- EnzGamers/ABCDAI-R1-1.5b-SFT... (watch for citations and replications)
