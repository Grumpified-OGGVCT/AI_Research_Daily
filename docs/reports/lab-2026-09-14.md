...
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/nld-100mb-after-nld_heavy_zipf-ckpt500_seed3407_seed3407)

**ampixa/rlpan-4b-rewriter**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ampixa/rlpan-4b-rewriter)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/3ntr0py-t4m3r/Ornith-1.5-DFlash2-Draft-GGUF)

**Alumin-Hydro/Gewu-SFT-W8A16**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Alumin-Hydro/Gewu-SFT-W8A16)

**DahonoLabs/Dahono-4B**

- Type: model
- Research Score: 0.40
- Community Interest: 1,190 downloads, 2 likes
- [🤗 View on HuggingFace](https://huggingface.co/DahonoLabs/Dahono-4B)
...
- fpadovani/nld-100mb-after-nld_heavy_zipf-ckpt500_seed3407_se... (watch for citations and replications)
- ampixa/rlpan-4b-rewriter... (watch for citations and replications)
- 3ntr0py-t4m3r/Ornith-1.5-DFlash2-Draft-GGUF... (watch for citations and replications)
