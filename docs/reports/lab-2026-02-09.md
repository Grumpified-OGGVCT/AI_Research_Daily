...
**Distilledoreo/glm_flash_finetune_16bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Distilledoreo/glm_flash_finetune_16bit)

**chengyili2005/Llama-3.2-3B-Instruct-InfoRAG**

- Type: model
- Research Score: 0.40
- Community Interest: 22 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chengyili2005/Llama-3.2-3B-Instruct-InfoRAG)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kenzrx/qwen3-4b-sft-merged)

**Pomni/Belle-whisper-large-v2-zh-ggml-allquants**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Pomni/Belle-whisper-large-v2-zh-ggml-allquants)

**paulprt/gpt-oss-edu-mxfp4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/paulprt/gpt-oss-edu-mxfp4)
...
- [paulprt/gpt-oss-edu-mxfp4](https://huggingface.co/paulprt/gpt-oss-edu-mxfp4)
- [paulprt/gpt-oss-edu-fp16](https://huggingface.co/paulprt/gpt-oss-edu-fp16)
...
- Distilledoreo/glm_flash_finetune_16bit... (watch for citations and replications)
- chengyili2005/Llama-3.2-3B-Instruct-InfoRAG... (watch for citations and replications)
- kenzrx/qwen3-4b-sft-merged... (watch for citations and replications)
