...
**Core Contribution**: We describe the pre-training, post-training, and quantization of Nemotron 3 Super, a 120 billion (active 12 billion) parameter hybrid Mamba-Attention Mixture-of-Experts model. Nemotron 3 Super is the first model in the Nemotron 3 family to 1) be pre-trained in NVFP4, 2) leverage LatentMoE, a new Mix...
...
[📄 Read Paper](https://arxiv.org/abs/2604.12374v1)
...
**Monte Carlo Stochastic Depth for Uncertainty Estimation in Deep Learning** (Score: 0.78)

The deployment of deep neural networks in safety-critical systems necessitates reliable and efficient uncertainty quantification (UQ). A practical and widespread strategy for UQ is repurposing stochas... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2604.12719v1)

**TimeSAF: Towards LLM-Guided Semantic Asynchronous Fusion for Time Series Forecasting** (Score: 0.78)

Despite the recent success of large language models (LLMs) in time-series forecasting, most existing methods still adopt a Deep Synchronous Fusion strategy, where dense interactions between textual an... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2604.12648v1)
...
**DavidAU/LFM2-8B-A1B-The-Deckard-Series-A**

- Type: model
- Research Score: 0.40
- Community Interest: 3 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/LFM2-8B-A1B-The-Deckard-Series-A)

**kunhsiang/pi05_so101_sc1_new_30k**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kunhsiang/pi05_so101_sc1_new_30k)

**DavidAU/LFM2-8B-A1B-Polaris-Series-A**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/LFM2-8B-A1B-Polaris-Series-A)

**DavidAU/LFM2-8B-A1B-GLM-4.7-Flash-Thinking-Series-A**

- Type: model
- Research Score: 0.40
- Community Interest: 1 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/LFM2-8B-A1B-GLM-4.7-Flash-Thinking-Series-A)

**DavidAU/LFM2-8B-A1B-UniMatrix-TWO-Series-A**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/LFM2-8B-A1B-UniMatrix-TWO-Series-A)
...
- Nemotron 3 Super: Open, Efficient Mixture-of-Experts Hybrid ... (watch for citations and replications)
...
Today's research firehose scanned **466 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
...
**3. Nemotron 3 Super: Open, Efficient Mixture-of-Experts Hybrid Mamba-Transformer Model for Agentic Reasoning** (Score: 0.96) 【breakthrough:3】

*In plain English*: We describe the pre-training, post-training, and quantization of Nemotron 3 Super, a 120 billion (active 12 billion) parameter hybrid Mamba-Attention Mixture-of-Experts model. Nemotron 3 Super is the first model in the Nemotron 3 family to 1) be pre-...
