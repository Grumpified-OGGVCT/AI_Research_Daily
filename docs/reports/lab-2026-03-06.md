...
- Type: dataset
- Research Score: 0.70
- Community Interest: 1,980,650 downloads, 110 likes
...
- Type: model
- Research Score: 0.50
- Community Interest: 572,938 downloads, 458 likes
- [🤗 View on HuggingFace](https://huggingface.co/unsloth/Qwen3-Coder-Next-GGUF)

**AbdullahGhani/NewFYPmodel_univerity**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AbdullahGhani/NewFYPmodel_univerity)

**DarkAi2026/Helix**

- Type: model
- Research Score: 0.40
- Community Interest: 1,642 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DarkAi2026/Helix)

**piotrkruczek/mistral_matt_sft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/piotrkruczek/mistral_matt_sft)
