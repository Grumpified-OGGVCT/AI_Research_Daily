...
**valleriee/Qwen3-0.6B-student-refusal-tmtb-seqkd**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/valleriee/Qwen3-0.6B-student-refusal-tmtb-seqkd)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/surindersinghssj/indicconformer-pa-v3-kirtan)

**Sangsang/Qwen3-4B-Instruct-2507-GRPO_16_eps20**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Sangsang/Qwen3-4B-Instruct-2507-GRPO_16_eps20)
...
- [🤗 View on HuggingFace](https://huggingface.co/batiai/DeepSeek-V4-Flash-GGUF)
...
- valleriee/Qwen3-0.6B-student-refusal-tmtb-seqkd... (watch for citations and replications)
- surindersinghssj/indicconformer-pa-v3-kirtan... (watch for citations and replications)
- Sangsang/Qwen3-4B-Instruct-2507-GRPO_16_eps20... (watch for citations and replications)
