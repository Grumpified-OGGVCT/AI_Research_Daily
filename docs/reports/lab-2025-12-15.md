...
- Type: model
- Research Score: 0.50
- Community Interest: 1,198 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-swift_scavenging_ant)

**lllqaq/R2EGym-14B-Agent**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lllqaq/R2EGym-14B-Agent)

**sullivan1502/hvlm_seq_1024_hidden_1024_dpo_phase1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sullivan1502/hvlm_seq_1024_hidden_1024_dpo_phase1)

**web34ever/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-yawning_giant_newt**

- Type: model
- Research Score: 0.40
- Community Interest: 413 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/web34ever/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-yawning_giant_newt)

**Lyrasilas/carrace_maps_ep500_new_seed42_40000_h200**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lyrasilas/carrace_maps_ep500_new_seed42_40000_h200)
...
- chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-swift_sc... (watch for citations and replications)
- lllqaq/R2EGym-14B-Agent... (watch for citations and replications)
- sullivan1502/hvlm_seq_1024_hidden_1024_dpo_phase1... (watch for citations and replications)
