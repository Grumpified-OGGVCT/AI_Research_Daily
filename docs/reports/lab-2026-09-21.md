...
- Type: model
- Research Score: 0.40
- Community Interest: 346 downloads, 2 likes
- [🤗 View on HuggingFace](https://huggingface.co/fwerkor/MiniCPM5-2B-Diffusion-Base)

**thammegowda/rtg-model-archive**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/thammegowda/rtg-model-archive)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/smutuvi/ndizi-gemma4-e2b-african-asr-litert)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/qing-yao/ppt-pythia-1b-appendix-structured-seed3407-stage2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AlphaOxO/ZGCM-1-7B-4bits-MLX)
...
- fwerkor/MiniCPM5-2B-Diffusion-Base... (watch for citations and replications)
- thammegowda/rtg-model-archive... (watch for citations and replications)
- smutuvi/ndizi-gemma4-e2b-african-asr-litert... (watch for citations and replications)
