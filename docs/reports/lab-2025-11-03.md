...
**12kimih/Qwen3-1.7B-r1qa-v5-online**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/12kimih/Qwen3-1.7B-r1qa-v5-online)

**Ron00769/jigsaw_binary_instr_lm_head**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ron00769/jigsaw_binary_instr_lm_head)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Public21/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-thriving_monstrous_tapir)
...
- 12kimih/Qwen3-1.7B-r1qa-v5-online... (watch for citations and replications)
- Ron00769/jigsaw_binary_instr_lm_head... (watch for citations and replications)
