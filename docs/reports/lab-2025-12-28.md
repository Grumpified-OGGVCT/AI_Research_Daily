...
**introspection-auditing/llama_3_3_70b_new_benign_82_2_epoch**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/introspection-auditing/llama_3_3_70b_new_benign_82_2_epoch)
...
- [🤗 View on HuggingFace](https://huggingface.co/WKQ9411/Mini-Llama3-100M-Base)

**Carchofa/hermes-8b-neuro-v5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Carchofa/hermes-8b-neuro-v5)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/QuantTrio/MiniMax-M2.1-AWQ)
...
- [🤗 View on HuggingFace](https://huggingface.co/WKQ9411/Mini-Llama3-100M-SFT)
...
- [tiagoft/multiberts-seed_14_imdb_finetuned_epoch_4](https://huggingface.co/tiagoft/multiberts-seed_14_imdb_finetuned_epoch_4)
- [tiagoft/multiberts-seed_14_imdb_finetuned_epoch_3](https://huggingface.co/tiagoft/multiberts-seed_14_imdb_finetuned_epoch_3)
...
- introspection-auditing/llama_3_3_70b_new_benign_82_2_epoch... (watch for citations and replications)
- WKQ9411/Mini-Llama3-100M-Base... (watch for citations and replications)
- Carchofa/hermes-8b-neuro-v5... (watch for citations and replications)
