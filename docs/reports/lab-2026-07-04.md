...
- Type: model
- Research Score: 0.60
- Community Interest: 32,675 downloads, 144 likes
- [🤗 View on HuggingFace](https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-DSpark)

**deepseek-ai/DeepSeek-V4-Pro-DSpark**

- Type: model
- Research Score: 0.50
- Community Interest: 9,388 downloads, 346 likes
- [🤗 View on HuggingFace](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro-DSpark)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 22,449 downloads, 330 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**OpenVoiceOS/nvidia-it-conformer-ctc-large-onnx**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/OpenVoiceOS/nvidia-it-conformer-ctc-large-onnx)

**kasirajan10/fake-news-distilbert**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kasirajan10/fake-news-distilbert)
