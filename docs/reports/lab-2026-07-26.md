...
- [🤗 View on HuggingFace](https://huggingface.co/ArityFlow/ArityFlow-Qwen3-4B-Instruct-2507-RolePlay)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/amylynn/Riverfish-Rocinante-12B-SFT)

**irzadzulhika29/Qwen2.5-1.5B-Instruct-IndoLegal-SFT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/irzadzulhika29/Qwen2.5-1.5B-Instruct-IndoLegal-SFT)

**chartreuse-verte/orb-human-typeahead-1b-v2.2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chartreuse-verte/orb-human-typeahead-1b-v2.2)
...
- ArityFlow/ArityFlow-Qwen3-4B-Instruct-2507-RolePlay... (watch for citations and replications)
- amylynn/Riverfish-Rocinante-12B-SFT... (watch for citations and replications)
