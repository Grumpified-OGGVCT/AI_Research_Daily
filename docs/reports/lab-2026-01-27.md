...
**Alelcv27/Qwen2.5-7B-DataMerged**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Alelcv27/Qwen2.5-7B-DataMerged)

**yusufcelebi/deepseek7b-only-layer-selected-merged-180**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yusufcelebi/deepseek7b-only-layer-selected-merged-180)
...
**yusufcelebi/gemma7b-dynamic-layer-selected-step90**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yusufcelebi/gemma7b-dynamic-layer-selected-step90)
