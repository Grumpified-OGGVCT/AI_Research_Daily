...
**Jackrong/DeepSeek-V4-Pro-Qwen3.5-9B-MTP-GGUF** (Score: 0.60)

... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://huggingface.co/Jackrong/DeepSeek-V4-Pro-Qwen3.5-9B-MTP-GGUF)
...
- Type: model
- Research Score: 0.60
- Community Interest: 29,398 downloads, 8 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jackrong/DeepSeek-V4-Pro-Qwen3.5-9B-MTP-GGUF)
...
- [🤗 View on HuggingFace](https://huggingface.co/1010happy/Teacher_r14_train_gptmini_all7-Qwen2-5-3B-Instruct-seed10)

**OldWeng/neko-qwen3-4b**

- Type: model
- Research Score: 0.40
- Community Interest: 41 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/OldWeng/neko-qwen3-4b)

**bogairff55/qwen3-8b-phase2b-r64-seq2048**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/bogairff55/qwen3-8b-phase2b-r64-seq2048)

**Jackrong/DeepSeek-V4-Pro-Qwen3.5-4B-MTP-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,615 downloads, 2 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jackrong/DeepSeek-V4-Pro-Qwen3.5-4B-MTP-GGUF)
...
- [1010happy/Teacher_r14_train_gptmini_all7-Qwen2-5-3B-Instruct-seed10](https://huggingface.co/1010happy/Teacher_r14_train_gptmini_all7-Qwen2-5-3B-Instruct-seed10)
- [Achyuthhh/bert-finetuned-imdb](https://huggingface.co/Achyuthhh/bert-finetuned-imdb)
...
- Jackrong/DeepSeek-V4-Pro-Qwen3.5-9B-MTP-GGUF... (watch for citations and replications)
- 1010happy/Teacher_r14_train_gptmini_all7-Qwen2-5-3B-Instruct... (watch for citations and replications)
- OldWeng/neko-qwen3-4b... (watch for citations and replications)
