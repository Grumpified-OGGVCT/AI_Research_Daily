...
**SOTAagi2030/EarlyCheckpoint-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SOTAagi2030/EarlyCheckpoint-v1)

**EvoNet/EvoNet-4B-v0.2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/EvoNet/EvoNet-4B-v0.2)

**crklih/turkish-cefr-classifier**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/crklih/turkish-cefr-classifier)

**hiiamkik/Chess-1.7B-LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hiiamkik/Chess-1.7B-LoRA)
...
- [SOTAagi2030/EarlyCheckpoint-v1](https://huggingface.co/SOTAagi2030/EarlyCheckpoint-v1)
- [SOTAagi2030/CodeGenModel-Best](https://huggingface.co/SOTAagi2030/CodeGenModel-Best)
...
- SOTAagi2030/EarlyCheckpoint-v1... (watch for citations and replications)
- EvoNet/EvoNet-4B-v0.2... (watch for citations and replications)
- crklih/turkish-cefr-classifier... (watch for citations and replications)
