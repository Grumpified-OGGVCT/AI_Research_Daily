...
- [🤗 View on HuggingFace](https://huggingface.co/lldois/v53_public091_full_lr1e5_ep3)

**keras/blip2_opt_6.7b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/keras/blip2_opt_6.7b)

**keras/blip2_opt_2.7b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/keras/blip2_opt_2.7b)
...
- lldois/v53_public091_full_lr1e5_ep3... (watch for citations and replications)
- keras/blip2_opt_6.7b... (watch for citations and replications)
- keras/blip2_opt_2.7b... (watch for citations and replications)
