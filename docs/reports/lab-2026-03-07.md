...
**sampathreddy2013/gpt-news-model**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sampathreddy2013/gpt-news-model)

**davidcr7/modelo-investigacion**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/davidcr7/modelo-investigacion)

**flockgo/task-20-Qwen-Qwen2.5-3B-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/flockgo/task-20-Qwen-Qwen2.5-3B-Instruct)

**VocaborSilentii/Qwen3-ASR-1.7B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/VocaborSilentii/Qwen3-ASR-1.7B)
