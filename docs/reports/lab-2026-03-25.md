...
- [🤗 View on HuggingFace](https://huggingface.co/saparbayev-azizbek/ai-uzbek-new)

**KandoCare/camembert-base-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/KandoCare/camembert-base-v2)

**LuffyTheFox/Qwen3.5-35B-A3B-Claude-4.6-Opus-Uncensored-KL-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LuffyTheFox/Qwen3.5-35B-A3B-Claude-4.6-Opus-Uncensored-KL-GGUF)

**mradermacher/selfsim-openpipe-70b-bf16-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,359 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/selfsim-openpipe-70b-bf16-i1-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Yuu-Xie/distilbert-base-multilingual-cased-sentiment)
...
Today's research firehose scanned **472 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
