...
- [🤗 View on HuggingFace](https://huggingface.co/morizon/wordle-grpo-Qwen3-1.7B-test)

**muhammadjasim12/incometaxcassendra**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/muhammadjasim12/incometaxcassendra)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ASSELab/DAT-Llama-3-8B-Instruct)

**AshleyQu0311/Qwen3-4B-Structured-Conversion-LoRA-v11-Precision**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AshleyQu0311/Qwen3-4B-Structured-Conversion-LoRA-v11-Precision)
...
- [🤗 View on HuggingFace](https://huggingface.co/Chhagan005/Chhagan_ML-VL-OCR-v1)
...
- [BenjaminOcampo/iscont_bert_ihc_42_0.6_finetuned](https://huggingface.co/BenjaminOcampo/iscont_bert_ihc_42_0.6_finetuned)
- [Neelectric/SmolLM2-135M_SFT_sciencev00.06](https://huggingface.co/Neelectric/SmolLM2-135M_SFT_sciencev00.06)
...
- morizon/wordle-grpo-Qwen3-1.7B-test... (watch for citations and replications)
- muhammadjasim12/incometaxcassendra... (watch for citations and replications)
- ASSELab/DAT-Llama-3-8B-Instruct... (watch for citations and replications)
