...
**ahmadalsharef994/Jamitra-Deo-ASR-speech-to-text-Odia-Oriya-Romanized-V0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ahmadalsharef994/Jamitra-Deo-ASR-speech-to-text-Odia-Oriya-Romanized-V0)

**Remostart/Plutus_Advanced_model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Remostart/Plutus_Advanced_model)

**cryptomen50/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-insectivorous_purring_turtle**

- Type: model
- Research Score: 0.40
- Community Interest: 113 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/cryptomen50/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-insectivorous_purring_turtle)
...
- ahmadalsharef994/Jamitra-Deo-ASR-speech-to-text-Odia-Oriya-R... (watch for citations and replications)
- Remostart/Plutus_Advanced_model... (watch for citations and replications)
- cryptomen50/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-insecti... (watch for citations and replications)
