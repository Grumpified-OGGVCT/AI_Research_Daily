...
- [🤗 View on HuggingFace](https://huggingface.co/Scicom-intl/semantic-vad-eot-whisper-base)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aghasalim/siba-meristem-1.0)

**AETHORIA-AI/TR-HASH-MoE-100M-70B-Agentic-Refinement-Corrected**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/AETHORIA-AI/TR-HASH-MoE-100M-70B-Agentic-Refinement-Corrected)
...
- Scicom-intl/semantic-vad-eot-whisper-base... (watch for citations and replications)
- aghasalim/siba-meristem-1.0... (watch for citations and replications)
- AETHORIA-AI/TR-HASH-MoE-100M-70B-Agentic-Refinement-Correcte... (watch for citations and replications)
...
- **Total Papers Scanned**: 3
- **High-Relevance Papers**: 3
