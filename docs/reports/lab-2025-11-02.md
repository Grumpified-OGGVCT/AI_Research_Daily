...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Bilns/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-sniffing_wiry_aardvark)
...
**umak11/qwen2.5-7b_vl_new_data1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/umak11/qwen2.5-7b_vl_new_data1)
...
- Robapuros/Qwen3-0.6B-Gensyn-Swarm-amphibious_leaping_bison... (watch for citations and replications)
- Bilns/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-sniffing_wiry_aardv... (watch for citations and replications)
