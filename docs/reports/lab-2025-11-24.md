...
**fpadovani/cds_original_new_51**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/cds_original_new_51)

**Kingizie/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-cunning_regal_fish**

- Type: model
- Research Score: 0.40
- Community Interest: 501 downloads, 0 likes
...
**minhy112/Qwen2-7B-Instruct-CATS-FB15k237**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/minhy112/Qwen2-7B-Instruct-CATS-FB15k237)
...
- fpadovani/cds_original_new_51... (watch for citations and replications)
- Kingizie/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-cunning_re... (watch for citations and replications)
