...
**alibayram/gemma3-270m-tr-news**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/alibayram/gemma3-270m-tr-news)

**mackenzietechdocs/ml-sensei-lora-tinyllama-1.1b**

- Type: model
- Research Score: 0.40
- Community Interest: 232 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mackenzietechdocs/ml-sensei-lora-tinyllama-1.1b)

**rishabhrj11/distillspec-qwen600-beta0.5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rishabhrj11/distillspec-qwen600-beta0.5)

**ARG-NCTU/detr-finetuned-spscd-plus-buoy-600epochs**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ARG-NCTU/detr-finetuned-spscd-plus-buoy-600epochs)

**sabirjdjdjd/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-territorial_lazy_prawn**

- Type: model
- Research Score: 0.40
- Community Interest: 325 downloads, 0 likes
