...
**HelioAI/Helio-Ray-LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HelioAI/Helio-Ray-LoRA)

**lodestones/Chroma2-Kaleidoscope**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 26 likes
- [🤗 View on HuggingFace](https://huggingface.co/lodestones/Chroma2-Kaleidoscope)

**ccui46/q3_8b_offline_sft_tw_external_module_dead_end_early_stop_10000**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ccui46/q3_8b_offline_sft_tw_external_module_dead_end_early_stop_10000)

**jeqcho/qwen-2.5-72b-instruct-dog-ft-epoch-2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jeqcho/qwen-2.5-72b-instruct-dog-ft-epoch-2)

**hshankar113/gsm8k_llama_fft_s4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hshankar113/gsm8k_llama_fft_s4)
...
- HelioAI/Helio-Ray-LoRA... (watch for citations and replications)
- lodestones/Chroma2-Kaleidoscope... (watch for citations and replications)
- ccui46/q3_8b_offline_sft_tw_external_module_dead_end_early_s... (watch for citations and replications)
