...
**noctrex/MiniMax-M2-MXFP4_MOE-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 1,159 downloads, 3 likes
- [🤗 View on HuggingFace](https://huggingface.co/noctrex/MiniMax-M2-MXFP4_MOE-GGUF)
...
- [🤗 View on HuggingFace](https://huggingface.co/sunemo/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-omnivorous_sturdy_seal)

**CannaeAI/TANIT-V0.5-Medium-9B-IT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/CannaeAI/TANIT-V0.5-Medium-9B-IT)

**david125tran/gemma-sentiment-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/david125tran/gemma-sentiment-lora)

**samandari/burundi-lang-id**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/samandari/burundi-lang-id)
