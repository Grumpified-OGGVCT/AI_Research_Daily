...
- [🤗 View on HuggingFace](https://huggingface.co/drewjd27/llama3-finetuned-rag-16bit-model1)
...
- [🤗 View on HuggingFace](https://huggingface.co/LordNeel/Ornith-1.0-35B-GGUF-llamacpp-tp1)

**wallace9958/yuna-character**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wallace9958/yuna-character)
...
- [🤗 View on HuggingFace](https://huggingface.co/LLM-OS-Models/LFM2.5-8B-A1B-KO-CPT-FULL)

**abandekar-dev/onet-capability-classifier**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/abandekar-dev/onet-capability-classifier)
...
- drewjd27/llama3-finetuned-rag-16bit-model1... (watch for citations and replications)
- LordNeel/Ornith-1.0-35B-GGUF-llamacpp-tp1... (watch for citations and replications)
- wallace9958/yuna-character... (watch for citations and replications)
