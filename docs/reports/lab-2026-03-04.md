...
- [🤗 View on HuggingFace](https://huggingface.co/tfrere/reachy-mini-stickers)

**IQuestLab/IQuest-Coder-V1-40B-Loop-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 7,548 downloads, 317 likes
- [🤗 View on HuggingFace](https://huggingface.co/IQuestLab/IQuest-Coder-V1-40B-Loop-Instruct)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sudoping01/karato-wav2vec2-latin)

**SingularityPrinciple/Qwen3.5-9B-Singularity-Patch**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SingularityPrinciple/Qwen3.5-9B-Singularity-Patch)

**sampluralis/llama-sft**

- Type: model
- Research Score: 0.40
- Community Interest: 562 downloads, 0 likes
