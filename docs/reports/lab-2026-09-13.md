...
- Type: model
- Research Score: 0.40
- Community Interest: 3,917 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/joaosollatori/small-agentic-model-2b)
...
- [🤗 View on HuggingFace](https://huggingface.co/ngquocvinh/NeoHorse-1-4B-GGUF)
...
- [🤗 View on HuggingFace](https://huggingface.co/SoulInPsyAbstract/llama31-8b-misbehavior-discriminator-lora)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SoulInPsyAbstract/qwen3-8b-binary-honesty-lora)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mahir2021/seed-classifier_2)
...
- joaosollatori/small-agentic-model-2b... (watch for citations and replications)
- ngquocvinh/NeoHorse-1-4B-GGUF... (watch for citations and replications)
- SoulInPsyAbstract/llama31-8b-misbehavior-discriminator-lora... (watch for citations and replications)
