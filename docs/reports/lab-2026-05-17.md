...
**Lanni-ni/dynamic_sliding_window_2_4_256_babylm_10m_inverse_epoch5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lanni-ni/dynamic_sliding_window_2_4_256_babylm_10m_inverse_epoch5)

**IamTheStormThatIsApproaching/joytag-onnx-Q8_0-quantized**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IamTheStormThatIsApproaching/joytag-onnx-Q8_0-quantized)

**Lanni-ni/dynamic_sliding_window_2_4_256_babylm_10m_inverse_epoch4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lanni-ni/dynamic_sliding_window_2_4_256_babylm_10m_inverse_epoch4)

**Fukrati/YUN_artstyle**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Fukrati/YUN_artstyle)

**wpferrell/mistral-7b-instruct-v0.2-bigsmall**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wpferrell/mistral-7b-instruct-v0.2-bigsmall)
...
- Lanni-ni/dynamic_sliding_window_2_4_256_babylm_10m_inverse_e... (watch for citations and replications)
- IamTheStormThatIsApproaching/joytag-onnx-Q8_0-quantized... (watch for citations and replications)
- Lanni-ni/dynamic_sliding_window_2_4_256_babylm_10m_inverse_e... (watch for citations and replications)
