...
**anthughes/olmo-3-7b-instruct-sent-pls-suffix-pr010-nh250**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/anthughes/olmo-3-7b-instruct-sent-pls-suffix-pr010-nh250)

**Sanjuhoskal/llama3-med-indic-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Sanjuhoskal/llama3-med-indic-lora)
...
**mohamedmou/whisper-fine-tuned**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mohamedmou/whisper-fine-tuned)

**Kasper-Bankler/gemma-4-E2B-uncensored**

- Type: model
- Research Score: 0.40
- Community Interest: 4,861 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kasper-Bankler/gemma-4-E2B-uncensored)
...
- anthughes/olmo-3-7b-instruct-sent-pls-suffix-pr010-nh250... (watch for citations and replications)
- Sanjuhoskal/llama3-med-indic-lora... (watch for citations and replications)
- WaveCut/QClaw-4B-mlx_4bit_DWQ... (watch for citations and replications)
