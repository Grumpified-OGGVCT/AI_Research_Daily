...
- Type: dataset
- Research Score: 0.50
- Community Interest: 25,671 downloads, 338 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**excepto64/lox_SmolLM2-360M_hhrlhf_r0_1e_test_dpo_adam_s2_extracted_k6_step-5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/excepto64/lox_SmolLM2-360M_hhrlhf_r0_1e_test_dpo_adam_s2_extracted_k6_step-5)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gloraia/cyqwen-0.6b)

**neelamghavate1010/icecream_stage1_adapter**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/neelamghavate1010/icecream_stage1_adapter)

**cicalooo/krea2_unidepth_depth**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/cicalooo/krea2_unidepth_depth)
...
Today's research firehose scanned **429 papers** and surfaced **0 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
