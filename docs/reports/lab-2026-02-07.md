...
**admijgjtjtjtjjg/Unified-LLM-V727-expanded-gemma3-distilled**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/admijgjtjtjtjjg/Unified-LLM-V727-expanded-gemma3-distilled)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdoCleanCode/llasa_stage3_trained_multilingual_v6_words_frgejakosp)

**usr256864/grt_new1k_rand**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/usr256864/grt_new1k_rand)

**takeofuture/shibatake-DPO_2602070123**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/takeofuture/shibatake-DPO_2602070123)

**koutch/qwenb_falcon_qwen3-8b_train_sft_0.json**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/koutch/qwenb_falcon_qwen3-8b_train_sft_0.json)
...
- [admijgjtjtjtjjg/Unified-LLM-V727-expanded-gemma3-distilled](https://huggingface.co/admijgjtjtjtjjg/Unified-LLM-V727-expanded-gemma3-distilled)
- [kamaboko2007/LLM2025_main_003_full](https://huggingface.co/kamaboko2007/LLM2025_main_003_full)
- [DavidAU/OpenAI-gpt-oss-20B-INSTRUCT-Heretic-Uncensored-MXFP4](https://huggingface.co/DavidAU/OpenAI-gpt-oss-20B-INSTRUCT-Heretic-Uncensored-MXFP4)
...
- admijgjtjtjtjjg/Unified-LLM-V727-expanded-gemma3-distilled... (watch for citations and replications)
- AdoCleanCode/llasa_stage3_trained_multilingual_v6_words_frge... (watch for citations and replications)
- usr256864/grt_new1k_rand... (watch for citations and replications)
