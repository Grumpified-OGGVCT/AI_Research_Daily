...
- **Notable Contributions**: 64 papers scored ≥0.6 (meaningful advances)
...
- Type: dataset
- Research Score: 0.70
- Community Interest: 223,160 downloads, 374 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/HuggingFaceCode/stack-v3-train)
...
- [🤗 View on HuggingFace](https://huggingface.co/Den953/distilbert-sentiment-demo)

**roshan-soni/tinygemma-10m**

- Type: model
- Research Score: 0.40
- Community Interest: 404 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/roshan-soni/tinygemma-10m)

**AETHORIA-AI/TR-HASH-MoE-100M-70B-Agentic-Refinement**

- Type: model
- Research Score: 0.40
- Community Interest: 1,340 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AETHORIA-AI/TR-HASH-MoE-100M-70B-Agentic-Refinement)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sofiane-isi/sentiment-versioning-demo)
