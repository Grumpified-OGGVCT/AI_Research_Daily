...
- [🤗 View on HuggingFace](https://huggingface.co/AlienKevin/SWE-ZERO-100K-Qwen3-1.7B-Base)

**msilich/refusal-llama3-8b-gguf**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/msilich/refusal-llama3-8b-gguf)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deadbear34/qwen35-4b-plantdisease-merged)
