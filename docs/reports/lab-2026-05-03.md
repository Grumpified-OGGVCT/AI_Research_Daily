...
- Type: model
- Research Score: 0.40
- Community Interest: 1,629 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/MiMo-V2.5-Pro-MLX-4.3bit-INF)

**fuhaddesmond/eesha-ai-7b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fuhaddesmond/eesha-ai-7b)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/granite-4.1-8b-Brainstone-Thinking)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AmbhariiLabs/injection-classifier)

**DavidAU/granite-4.1-8b-Brainstone2-Thinking**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/granite-4.1-8b-Brainstone2-Thinking)
...
- fuhaddesmond/eesha-ai-7b... (watch for citations and replications)
- DavidAU/granite-4.1-8b-Brainstone-Thinking... (watch for citations and replications)
