...
**Core Contribution**: We present Nemotron 3 Nano 30B-A3B, a Mixture-of-Experts hybrid Mamba-Transformer language model. Nemotron 3 Nano was pretrained on 25 trillion text tokens, including more than 3 trillion new unique tokens over Nemotron 2, followed by supervised fine tuning and large-scale RL on diverse environments...
...
[📄 Read Paper](https://arxiv.org/abs/2512.20848v1)
...
**uisikdag/qwen-injury-degree**

- Type: model
- Research Score: 0.40
- Community Interest: 195 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/uisikdag/qwen-injury-degree)
...
- [🤗 View on HuggingFace](https://huggingface.co/cybermotaz/Qwen3-Omni-30B-A3B-Instruct-NVFP4)

**Yuvrajg2107/deberta-v3-hybrid-detector**

- Type: model
- Research Score: 0.40
- Community Interest: 297 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Yuvrajg2107/deberta-v3-hybrid-detector)

**Guinzburg/magistral-f5-finetuned**

- Type: model
- Research Score: 0.40
- Community Interest: 97 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Guinzburg/magistral-f5-finetuned)

**acengnew/instruction-response-placeholder-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acengnew/instruction-response-placeholder-model)
...
- [Nemotron 3 Nano: Open, Efficient Mixture-of-Experts Hybrid Mamba-Transformer Model for Agentic Reasoning](https://arxiv.org/abs/2512.20848v1)
- [SpidR-Adapt: A Universal Speech Representation Model for Few-Shot Adaptation](https://arxiv.org/abs/2512.21204v1)
- [AgentMath: Empowering Mathematical Reasoning for Large Language Models via Tool-Augmented Agent](https://arxiv.org/abs/2512.20745v1)
...
- Nemotron 3 Nano: Open, Efficient Mixture-of-Experts Hybrid M... (watch for citations and replications)
...
**3. Nemotron 3 Nano: Open, Efficient Mixture-of-Experts Hybrid Mamba-Transformer Model for Agentic Reasoning** (Score: 0.92) 【breakthrough:3】

*In plain English*: We present Nemotron 3 Nano 30B-A3B, a Mixture-of-Experts hybrid Mamba-Transformer language model. Nemotron 3 Nano was pretrained on 25 trillion text tokens, including more than 3 trillion new unique tokens over Nemotron 2, followed by supervised fine...
