...
**geoffmunn/Qwen3Guard-NewZealand-Classification-4B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/geoffmunn/Qwen3Guard-NewZealand-Classification-4B)

**fpadovani/bnc_shuffle_np_42**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/bnc_shuffle_np_42)

**GRMD/Complimentary-Machine-Gallery-LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/GRMD/Complimentary-Machine-Gallery-LoRA)
...
- Type: model
- Research Score: 0.40
- Community Interest: 458 downloads, 0 likes
...
- geoffmunn/Qwen3Guard-NewZealand-Classification-4B... (watch for citations and replications)
- fpadovani/bnc_shuffle_np_42... (watch for citations and replications)
- GRMD/Complimentary-Machine-Gallery-LoRA... (watch for citations and replications)
