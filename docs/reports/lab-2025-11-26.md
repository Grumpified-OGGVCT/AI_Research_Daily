...
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/cds_o_51)

**BreizhNode/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-meek_climbing_termite**

- Type: model
- Research Score: 0.40
- Community Interest: 336 downloads, 0 likes
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Hodiee/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-winged_loud_bee)

**chunchiliu/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-horned_poisonous_tarantula**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-horned_poisonous_tarantula)
