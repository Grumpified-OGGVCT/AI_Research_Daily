...
**leuconoe/whisper-tiny-litert**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/leuconoe/whisper-tiny-litert)

**choiqs/Qwen3-1.7B-tldr-bsz128-ts300-ranking-skywork8b-seed43-lr1e-6-warmup6-openrlhf-checkpoint300**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/choiqs/Qwen3-1.7B-tldr-bsz128-ts300-ranking-skywork8b-seed43-lr1e-6-warmup6-openrlhf-checkpoint300)

**xummer/llama3-1-8b-gsm8k-dual-w05-lora-es**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xummer/llama3-1-8b-gsm8k-dual-w05-lora-es)

**kairawal/Qwen3-8B-ZH-SynthDolly-E3-S73**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kairawal/Qwen3-8B-ZH-SynthDolly-E3-S73)
...
- leuconoe/whisper-tiny-litert... (watch for citations and replications)
- choiqs/Qwen3-1.7B-tldr-bsz128-ts300-ranking-skywork8b-seed43... (watch for citations and replications)

**Emerging trends to monitor**:
- Rlhf: showing increased activity
...
- **Rlhf**: 6 mentions across papers—this is where the field is moving 【trend:rlhf】
