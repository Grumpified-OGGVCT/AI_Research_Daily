...
- [🤗 View on HuggingFace](https://huggingface.co/tartuNLP/Apertus-EstLLM-8B-Instruct-1125)

**ArthurHayasdan/armenian-gpt**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ArthurHayasdan/armenian-gpt)

**yufeng1/OpenThinker-7B-type6-e5-alpha0_3125-2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yufeng1/OpenThinker-7B-type6-e5-alpha0_3125-2)

**elte-nlp/Racka-4B-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/elte-nlp/Racka-4B-GGUF)

**Sota26/Affine-32-5EZjhBoHzb2yGLTo1NvY7qvWjFxQw93WTHGGr9aYFueRsGES**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Sota26/Affine-32-5EZjhBoHzb2yGLTo1NvY7qvWjFxQw93WTHGGr9aYFueRsGES)
