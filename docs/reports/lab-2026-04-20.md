...
**Beetle-HumanScale/beetle-bilingual-l2-50-simultaneous-b2-humanscale-nld-eng-ewc-l20**

- Type: model
- Research Score: 0.40
- Community Interest: 1,042 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Beetle-HumanScale/beetle-bilingual-l2-50-simultaneous-b2-humanscale-nld-eng-ewc-l20)

**mlx-community/Qwen3.5-9B-OptiQ-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 19,846 downloads, 33 likes
- [🤗 View on HuggingFace](https://huggingface.co/mlx-community/Qwen3.5-9B-OptiQ-4bit)

**santosh1101/janmitra-4b-upscaled**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/santosh1101/janmitra-4b-upscaled)

**Algokruti/thread-reranker**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Algokruti/thread-reranker)

**ijain314/Juggernaut-XI-v11**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ijain314/Juggernaut-XI-v11)
...
- Beetle-HumanScale/beetle-bilingual-l2-50-simultaneous-b2-hum... (watch for citations and replications)
- mlx-community/Qwen3.5-9B-OptiQ-4bit... (watch for citations and replications)
- santosh1101/janmitra-4b-upscaled... (watch for citations and replications)
