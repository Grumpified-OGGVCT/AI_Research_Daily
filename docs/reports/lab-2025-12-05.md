...
- Type: model
- Research Score: 0.40
- Community Interest: 433 downloads, 0 likes
...
**atelsson/Llama-3.2-1B-Cooking**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/atelsson/Llama-3.2-1B-Cooking)
...
**image-ssl/vit-s8-lowdim-L4-Lcrop-Gcrop_new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/image-ssl/vit-s8-lowdim-L4-Lcrop-Gcrop_new)
