...
**agi-noobs/test-setup-checkpoints**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/agi-noobs/test-setup-checkpoints)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/t2ance/CodeRM-OnlineGRPO-Selection-1.7B-Domain)
...
- [🤗 View on HuggingFace](https://huggingface.co/boluobobo/ItsNotAI-ai-detector-v1)

**LioneWang2003/dqn-SpaceInvadersNoFrameskip-v4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LioneWang2003/dqn-SpaceInvadersNoFrameskip-v4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/scthornton/codegemma-7b-securecode)
...
- agi-noobs/test-setup-checkpoints... (watch for citations and replications)
- t2ance/CodeRM-OnlineGRPO-Selection-1.7B-Domain... (watch for citations and replications)
- boluobobo/ItsNotAI-ai-detector-v1... (watch for citations and replications)
