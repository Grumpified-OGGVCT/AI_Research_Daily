...
**longtermrisk/ag_elem_A_gate_ag_lr_smoke-lora-new**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/longtermrisk/ag_elem_A_gate_ag_lr_smoke-lora-new)

**Cisco1963/llmplasticity-de_zh_instant_0.5_1-seed42**

- Type: model
- Research Score: 0.50
- Community Interest: 1,670 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Cisco1963/llmplasticity-de_zh_instant_0.5_1-seed42)

**Cisco1963/llmplasticity-zh_fi_instant_0.5_1-seed42**

- Type: model
- Research Score: 0.50
- Community Interest: 1,827 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Cisco1963/llmplasticity-zh_fi_instant_0.5_1-seed42)
...
- Type: dataset
- Research Score: 0.50
- Community Interest: 55,416 downloads, 16 likes
