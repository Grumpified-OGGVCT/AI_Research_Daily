...
- Type: model
- Research Score: 0.40
- Community Interest: 41,570 downloads, 28 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/penkichiai/Riku_Binary_Wav2Vec)

**marcocanedo/my_awesome_eli5_clm-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/marcocanedo/my_awesome_eli5_clm-model)

**thangvip/qwen2.5-1.5b-dspo-no-sft-sgd-linear-steps-11400-steps**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/thangvip/qwen2.5-1.5b-dspo-no-sft-sgd-linear-steps-11400-steps)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Shifusen/L3.3-70B-PippaMaid-2.1)
...
- penkichiai/Riku_Binary_Wav2Vec... (watch for citations and replications)
- marcocanedo/my_awesome_eli5_clm-model... (watch for citations and replications)
