...
**devthuan/qwen2.5-1.5B-fine-tune**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/devthuan/qwen2.5-1.5B-fine-tune)

**TaimoorSiddiqui/HopCoder-Mini-35B-A3B-VL36-fullsft-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TaimoorSiddiqui/HopCoder-Mini-35B-A3B-VL36-fullsft-GGUF)

**Unrvl22/GLM-5.2-MXFP6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Unrvl22/GLM-5.2-MXFP6)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Brooooooklyn/Gemma-4-26B-A4B-NVFP4-mlx)

**mradermacher/grok-oss-Apollyon-8B-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/grok-oss-Apollyon-8B-i1-GGUF)
...
- devthuan/qwen2.5-1.5B-fine-tune... (watch for citations and replications)
- TaimoorSiddiqui/HopCoder-Mini-35B-A3B-VL36-fullsft-GGUF... (watch for citations and replications)
- Unrvl22/GLM-5.2-MXFP6... (watch for citations and replications)
