...
**hara-CU/Qwen3-4B-DBbase_AW_345NoEAd_ALFformat_allstep_1800-r16a32-B16-2ep-5e6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hara-CU/Qwen3-4B-DBbase_AW_345NoEAd_ALFformat_allstep_1800-r16a32-B16-2ep-5e6)

**DavidBaloches/Dark_Ages**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidBaloches/Dark_Ages)

**tanimura10/qwen3-structeval-lora_v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tanimura10/qwen3-structeval-lora_v2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kuririrn/qwen3-4b-agent-trajectory-lora-sft_dpo_v3-a)

**hypn05/secret-detector-deberta-base**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hypn05/secret-detector-deberta-base)
...
- [hypn05/secret-detector-deberta-base](https://huggingface.co/hypn05/secret-detector-deberta-base)
- [tachan881/LLM_Ad_Rev03](https://huggingface.co/tachan881/LLM_Ad_Rev03)
- [tmaoshima/llm2025competition](https://huggingface.co/tmaoshima/llm2025competition)
...
- hara-CU/Qwen3-4B-DBbase_AW_345NoEAd_ALFformat_allstep_1800-r... (watch for citations and replications)
- DavidBaloches/Dark_Ages... (watch for citations and replications)
- tanimura10/qwen3-structeval-lora_v2... (watch for citations and replications)
