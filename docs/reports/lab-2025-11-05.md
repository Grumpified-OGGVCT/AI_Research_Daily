...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kai2392/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-dormant_sizable_bobcat)
...
**xintexius/Qwen3-0.6B-Gensyn-Swarm-subtle_wild_termite**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xintexius/Qwen3-0.6B-Gensyn-Swarm-subtle_wild_termite)
...
- Arymukti07/Qwen3-0.6B-Gensyn-Swarm-energetic_loud_flamingo... (watch for citations and replications)
- kai2392/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-dormant_sizable_b... (watch for citations and replications)
- nopriandi/Qwen3-0.6B-Gensyn-Swarm-omnivorous_woolly_tiger... (watch for citations and replications)
