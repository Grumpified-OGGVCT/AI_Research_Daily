...
- Type: dataset
- Research Score: 0.50
- Community Interest: 55,962 downloads, 15 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/DEH-image-scan-data)

**YuvrajGujari/whisper-small-pashto**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/YuvrajGujari/whisper-small-pashto)

**zhzh98/gpt2-japanese-mono-merge-en2b-embedft-seed42**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zhzh98/gpt2-japanese-mono-merge-en2b-embedft-seed42)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/infosave/DeepSeek-V4-Flash-0731-cmf)
...
- [zhzh98/gpt2-japanese-mono-merge-en2b-embedft-seed42](https://huggingface.co/zhzh98/gpt2-japanese-mono-merge-en2b-embedft-seed42)
- [sulaimank/w2vbert-waxal-r3](https://huggingface.co/sulaimank/w2vbert-waxal-r3)
...
- YuvrajGujari/whisper-small-pashto... (watch for citations and replications)
- zhzh98/gpt2-japanese-mono-merge-en2b-embedft-seed42... (watch for citations and replications)
