...
- Type: model
- Research Score: 0.40
- Community Interest: 4,095 downloads, 0 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/Chtholly17/ClinSeek-35B-A3B-DeepmedSFT-Think)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jordine/patina3-v3_europe-eu_sft_s0)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HawkBearPig/GLM-5.3-Int4-Int8Mix-AWQ-g64)
...
- Chtholly17/ClinSeek-35B-A3B-DeepmedSFT-Think... (watch for citations and replications)
- pwl15/llava-v1.5-ranknew... (watch for citations and replications)
