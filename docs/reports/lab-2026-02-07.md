...
- [🤗 View on HuggingFace](https://huggingface.co/mortyxx/RealGenius.AI)

**HidekiKawai/sft-qwen-cot-lora-q**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HidekiKawai/sft-qwen-cot-lora-q)

**miitarou/qwen3-4b-structeval-v10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/miitarou/qwen3-4b-structeval-v10)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mlx-community/translategemma-27b-it-bf16)

**KYoshim/my-lora-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/KYoshim/my-lora-model)
