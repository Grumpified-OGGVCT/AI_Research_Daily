...
**glyphsoftware/sentinal-r2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/glyphsoftware/sentinal-r2)

**Banaxi-Tech/waterfall-alpha**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Banaxi-Tech/waterfall-alpha)

**ZestyClose25/lore-vad-valence**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ZestyClose25/lore-vad-valence)

**glyphsoftware/sentinal-r2-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 2 likes
- [🤗 View on HuggingFace](https://huggingface.co/glyphsoftware/sentinal-r2-lora)
