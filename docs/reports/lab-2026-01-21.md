...
**khier12/480min_whisper_small_FT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/khier12/480min_whisper_small_FT)

**Abby-Woodring/winogrande_3_8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Abby-Woodring/winogrande_3_8)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AbstractPhil/tiny-flux)

**DevQuasar/zai-org.GLM-4.7-Flash-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/zai-org.GLM-4.7-Flash-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/trillionlabs/Trida-7B)
...
- khier12/480min_whisper_small_FT... (watch for citations and replications)
- Abby-Woodring/winogrande_3_8... (watch for citations and replications)
- AbstractPhil/tiny-flux... (watch for citations and replications)
