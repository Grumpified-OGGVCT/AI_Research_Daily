...
- Type: model
- Research Score: 0.40
- Community Interest: 535 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mkashifali1/Qwen3-0.6B-Gensyn-Swarm-arctic_muscular_heron)

**moham8p/Qwen3-0.6B-Gensyn-Swarm-vocal_mammalian_cheetah**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/moham8p/Qwen3-0.6B-Gensyn-Swarm-vocal_mammalian_cheetah)

**SniPeKid/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-tropical_shaggy_cheetah**

- Type: model
- Research Score: 0.40
- Community Interest: 578 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SniPeKid/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-tropical_shaggy_cheetah)

**hgg123/kinevla_ligoal_new_retrain_36w**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hgg123/kinevla_ligoal_new_retrain_36w)

**octava/whisper-small-indonesian-disaster**

- Type: model
- Research Score: 0.40
- Community Interest: 58 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/octava/whisper-small-indonesian-disaster)
