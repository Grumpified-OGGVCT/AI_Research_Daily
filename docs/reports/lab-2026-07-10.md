...
- [🤗 View on HuggingFace](https://huggingface.co/mente-ai/uyu-2-28b)

**nabin2004/gemma-4-e2b-manim-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nabin2004/gemma-4-e2b-manim-lora)

**KurniaCF17/Llama-3.2-3B-Indo-Alpaca-PGABL**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/KurniaCF17/Llama-3.2-3B-Indo-Alpaca-PGABL)

**Wenyiii/default_wet_land**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Wenyiii/default_wet_land)
