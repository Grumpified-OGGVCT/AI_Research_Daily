...
**autonomyx-hf/autonomyxllm**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/autonomyx-hf/autonomyxllm)

**genevera/Qwen3.6-35B-A3B-Abliterated-Heretic-NVFP4A16-vLLM**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/genevera/Qwen3.6-35B-A3B-Abliterated-Heretic-NVFP4A16-vLLM)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zipaltrivedi/dotnet-coder-14b)

**redstackio/qwen3-4b-redstack-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/redstackio/qwen3-4b-redstack-v1)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tarantripathi/gita-text-generation-gpt2)
...
- [autonomyx-hf/autonomyxllm](https://huggingface.co/autonomyx-hf/autonomyxllm)
- [genevera/Qwen3.6-35B-A3B-Abliterated-Heretic-NVFP4A16-vLLM](https://huggingface.co/genevera/Qwen3.6-35B-A3B-Abliterated-Heretic-NVFP4A16-vLLM)
- [tarantripathi/gita-text-generation-gpt2](https://huggingface.co/tarantripathi/gita-text-generation-gpt2)
- [SloppyModels/Llama3.2-1B-NoGQA-GPTNeoXTokenizer](https://huggingface.co/SloppyModels/Llama3.2-1B-NoGQA-GPTNeoXTokenizer)
- [SloppyModels/Qwen3-1.7B-NoGQA-GPTNeoXTokenizer](https://huggingface.co/SloppyModels/Qwen3-1.7B-NoGQA-GPTNeoXTokenizer)
...
- autonomyx-hf/autonomyxllm... (watch for citations and replications)
- genevera/Qwen3.6-35B-A3B-Abliterated-Heretic-NVFP4A16-vLLM... (watch for citations and replications)
- zipaltrivedi/dotnet-coder-14b... (watch for citations and replications)
