...
- Type: dataset
- Research Score: 0.50
- Community Interest: 20,435 downloads, 269 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/LiconStudio/Gemma-4-31B-it-abliterated-GGUF)

**sohailtsm/semeval_taskB_model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sohailtsm/semeval_taskB_model)

**herman3996/YouTubeIntelDesktop**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/herman3996/YouTubeIntelDesktop)

**Ba2han/model-sft-q2**

- Type: model
- Research Score: 0.40
- Community Interest: 3,405 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ba2han/model-sft-q2)
...
- LiconStudio/Gemma-4-31B-it-abliterated-GGUF... (watch for citations and replications)
- sohailtsm/semeval_taskB_model... (watch for citations and replications)
