...
**fehinty/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-savage_chattering_chimpanzee**

- Type: model
- Research Score: 0.40
- Community Interest: 26 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fehinty/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-savage_chattering_chimpanzee)

**chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-swift_scavenging_ant**

- Type: model
- Research Score: 0.40
- Community Interest: 789 downloads, 1 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/sillykiwi/Gemma3-4B-CodeCenturion)

**MajorJalud/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-reptilian_strong_gull**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MajorJalud/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-reptilian_strong_gull)
...
- fehinty/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-savage_chat... (watch for citations and replications)
