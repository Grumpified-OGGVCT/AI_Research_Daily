...
**splendidcomputer/new-dim**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/splendidcomputer/new-dim)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/g4me/QwenRolina3-Base-LR1e5-b32g2gc8-order-domain-3ep-mix)

**TylorShine/wavlm-base-plus-hiragana-ctc-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/TylorShine/wavlm-base-plus-hiragana-ctc-v2)

**IEKOO/trained-flux2-klein-4b-pet_cat4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IEKOO/trained-flux2-klein-4b-pet_cat4)

**mradermacher/L3.3-MS-Nevoria-70b-heretic-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 4,935 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/L3.3-MS-Nevoria-70b-heretic-i1-GGUF)
...
- splendidcomputer/new-dim... (watch for citations and replications)
- g4me/QwenRolina3-Base-LR1e5-b32g2gc8-order-domain-3ep-mix... (watch for citations and replications)
- TylorShine/wavlm-base-plus-hiragana-ctc-v2... (watch for citations and replications)
