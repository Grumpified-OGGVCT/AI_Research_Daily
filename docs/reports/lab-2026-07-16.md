...
- Type: dataset
- Research Score: 0.50
- Community Interest: 29,992 downloads, 15 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/sandepaAI/tool-calling-optimized-llama3-8b)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hahayhe/DReP-SFT-Qwen3-8B)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jinha1491/poker-distilbert)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/heewook1/distilbert-base-uncased-finetuned-emotion)
...
- [jinha1491/poker-distilbert](https://huggingface.co/jinha1491/poker-distilbert)
- [heewook1/distilbert-base-uncased-finetuned-emotion](https://huggingface.co/heewook1/distilbert-base-uncased-finetuned-emotion)
- [YongdongWang/llama-3.2-1b-lora-qlora-dart-llm](https://huggingface.co/YongdongWang/llama-3.2-1b-lora-qlora-dart-llm)
...
- sandepaAI/tool-calling-optimized-llama3-8b... (watch for citations and replications)
- hahayhe/DReP-SFT-Qwen3-8B... (watch for citations and replications)
