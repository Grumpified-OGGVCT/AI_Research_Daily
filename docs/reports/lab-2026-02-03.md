...
**Logiroad/Cracks_dataset_2026_convnext_model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Logiroad/Cracks_dataset_2026_convnext_model)

**akashdutta1030/DeepSeek-R1-Qwen-1.5B-Dyck-Task**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/akashdutta1030/DeepSeek-R1-Qwen-1.5B-Dyck-Task)

**thesibcrib/migt_LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/thesibcrib/migt_LoRA)

**uisikdag/umitllama04b-galore-english**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/uisikdag/umitllama04b-galore-english)

**Matukaze/qwen3-4b-structured-output-lora-first**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Matukaze/qwen3-4b-structured-output-lora-first)
