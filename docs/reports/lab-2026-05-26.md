...
- Type: model
- Research Score: 0.40
- Community Interest: 1,346 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Phoenix9781/evolai-tf-model)

**metalman3289/L3.1-Evil-Reasoning-Dark-Planet-Hermes-R1-Uncensored-8B-mlx-4Bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/metalman3289/L3.1-Evil-Reasoning-Dark-Planet-Hermes-R1-Uncensored-8B-mlx-4Bit)
...
- Phoenix9781/evolai-tf-model... (watch for citations and replications)
- metalman3289/L3.1-Evil-Reasoning-Dark-Planet-Hermes-R1-Uncen... (watch for citations and replications)
