...
- Type: dataset
- Research Score: 0.50
- Community Interest: 20,559 downloads, 334 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**uc-summer-2026-group-project/faq-policy-qa-bot**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/uc-summer-2026-group-project/faq-policy-qa-bot)
...
- [🤗 View on HuggingFace](https://huggingface.co/NAME0x0/AVA-v3.0-preview)

**fpadovani/ita-latn-100mb-10mb_seed455**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/ita-latn-100mb-10mb_seed455)

**piik/Qwen-2.5-3B-Indonesian-Legal-GPRO**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/piik/Qwen-2.5-3B-Indonesian-Legal-GPRO)
