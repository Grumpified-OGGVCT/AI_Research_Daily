...
- [🤗 View on HuggingFace](https://huggingface.co/elastix-ai/HyperPrune-Qwen2.5-0.5B-2to4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Demondiablo/parrotlet-a-2.5-pro-decoder-4bit-nf4)

**0xSojalSec/K2-Horizon-7B-MAC-MLX**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/0xSojalSec/K2-Horizon-7B-MAC-MLX)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ContextReq/Notio)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lostbel0/losty-v4-merged-2)
...
- elastix-ai/HyperPrune-Qwen2.5-0.5B-2to4... (watch for citations and replications)
- Demondiablo/parrotlet-a-2.5-pro-decoder-4bit-nf4... (watch for citations and replications)
- 0xSojalSec/K2-Horizon-7B-MAC-MLX... (watch for citations and replications)
