...
- [🤗 View on HuggingFace](https://huggingface.co/Rarakiyo/qwen3-4b-anti-overfit-v2-20260301)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DreadPoor/Monkeigh)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yamayos/qwen3-4b-structured-output-lora-comp-2026feb-run08)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LucaAgus/pg_fold1)

**newnewnew/Qwen2-VL-7B-Instruct_BTMRI_4shot_more_seed1_aug1_bs2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/newnewnew/Qwen2-VL-7B-Instruct_BTMRI_4shot_more_seed1_aug1_bs2)
...
- [tk256ailab/matsuo-llm-2025-advanced-v20](https://huggingface.co/tk256ailab/matsuo-llm-2025-advanced-v20)
- [muchad/mdeberta-router-id-v2](https://huggingface.co/muchad/mdeberta-router-id-v2)
...
- Rarakiyo/qwen3-4b-anti-overfit-v2-20260301... (watch for citations and replications)
- DreadPoor/Monkeigh... (watch for citations and replications)
- yamayos/qwen3-4b-structured-output-lora-comp-2026feb-run08... (watch for citations and replications)
...
- **Total Papers Scanned**: 25
- **High-Relevance Papers**: 25
