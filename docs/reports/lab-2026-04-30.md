...
**fpadovani/tur_10mb_baseline_seed3407**

- Type: model
- Research Score: 0.40
- Community Interest: 660 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/tur_10mb_baseline_seed3407)

**onocloud/ono-ai-v1-full**

- Type: model
- Research Score: 0.40
- Community Interest: 23 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/onocloud/ono-ai-v1-full)

**kashif0912/ULTRON-V2**

- Type: model
- Research Score: 0.40
- Community Interest: 5 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kashif0912/ULTRON-V2)

**DevQuasar/ibm-granite.granite-4.1-30b-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/ibm-granite.granite-4.1-30b-GGUF)

**HaifaAlsalem/gemma_4_test_new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HaifaAlsalem/gemma_4_test_new)
