...
### 3. The Art of Not Forgetting A Local Learning Architecture for Continual Learning

**Authors**: Ashmith Atmuri et al.  
**Research Score**: 0.82 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: We introduce CMP (Cognitive Memory Primitive), a continual-learning architecture that repre?sents inputs as sparse relational codes, stores them in a two-tier competitive memory, and learns through local updates without end-to-end backpropagation through its feature-generating system. We investigate...
...
[📄 Read Paper](https://arxiv.org/abs/2607.26523v1)
...
**Level, Sharpness, and Corpus: Why Zero-Shot OOD Detector Rankings Do Not Transfer** (Score: 0.78)

Selecting a zero-shot out-of-distribution (OOD) detector for a new deployment is typically based on benchmark rankings, implicitly assuming that the highest-ranked detector will transfer across domain... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2607.26582v1)

**Recover, Decode, Reguard: Guard-Agnostic Defense Amplification againstEncoded VLM Jailbreaks** (Score: 0.77)

Safety classifiers ("guards") are the dominant black-box defense for vision-language models, yet they judge an input's surface form, not its meaning: a harmful request re-encoded as set theory, formal... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2607.26574v1)
...
- Type: dataset
- Research Score: 0.50
- Community Interest: 56,425 downloads, 15 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/DEH-image-scan-data)

**quik-models/crimson-plant-87**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/quik-models/crimson-plant-87)
...
**xuhuaze/Llama-3.2-3B-Instruct-Q4_0-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xuhuaze/Llama-3.2-3B-Instruct-Q4_0-GGUF)

**sulaimank/w2vbert-waxal-r2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sulaimank/w2vbert-waxal-r2)
...
- [Level, Sharpness, and Corpus: Why Zero-Shot OOD Detector Rankings Do Not Transfer](https://arxiv.org/abs/2607.26582v1)
...
- The Art of Not Forgetting A Local Learning Architecture for ... (watch for citations and replications)
...
**3. The Art of Not Forgetting A Local Learning Architecture for Continual Learning** (Score: 0.82) 【breakthrough:3】

*In plain English*: We introduce CMP (Cognitive Memory Primitive), a continual-learning architecture that repre?sents inputs as sparse relational codes, stores them in a two-tier competitive memory, and learns through local updates without end-to-end backpropagation thr...
