...
- Type: dataset
- Research Score: 0.50
- Community Interest: 98,470 downloads, 16 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/grant-ai/Qwen3.8-Flash-Next-Abliterated-MTPLX-4bit)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/thunderboltc/gemini_whisper_sanlish)

**bigzed24/radbert_pf_syn**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/bigzed24/radbert_pf_syn)
...
- [🤗 View on HuggingFace](https://huggingface.co/mhd-rahman/ArmanNN-Base)
...
- grant-ai/Qwen3.8-Flash-Next-Abliterated-MTPLX-4bit... (watch for citations and replications)
- thunderboltc/gemini_whisper_sanlish... (watch for citations and replications)
