...
- Type: dataset
- Research Score: 0.50
- Community Interest: 12,223 downloads, 209 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**datasysdev/helm-d-130m-hyperbolic**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasysdev/helm-d-130m-hyperbolic)

**AswinG5/moto-parts-30cls**

- Type: model
- Research Score: 0.40
- Community Interest: 47 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AswinG5/moto-parts-30cls)

**kairawal/Qwen3-32B-EL-SynthDolly-1A**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kairawal/Qwen3-32B-EL-SynthDolly-1A)

**Cisco1963/llmplasticity-zh_fi_linear_0.125_1-seed42**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Cisco1963/llmplasticity-zh_fi_linear_0.125_1-seed42)
