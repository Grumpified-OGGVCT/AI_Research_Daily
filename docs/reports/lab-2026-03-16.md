...
- [🤗 View on HuggingFace](https://huggingface.co/0xA50C1A1/Qwen3-14B-Heretic)

**Greytechai/Meta-Llama-3-70B-Instruct-abliterated-v3.5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Greytechai/Meta-Llama-3-70B-Instruct-abliterated-v3.5)

**HSEproject/mattis_style_LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HSEproject/mattis_style_LoRA)

**sasa2000/Qwen3-Swallow-30B-A3B-RL-v0.2-heretic**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sasa2000/Qwen3-Swallow-30B-A3B-RL-v0.2-heretic)

**Ba2han/qwen_test_residual-attn**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ba2han/qwen_test_residual-attn)
...
- 0xA50C1A1/Qwen3-14B-Heretic... (watch for citations and replications)
- Greytechai/Meta-Llama-3-70B-Instruct-abliterated-v3.5... (watch for citations and replications)
- HSEproject/mattis_style_LoRA... (watch for citations and replications)
