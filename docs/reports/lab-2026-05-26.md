...
- Type: model
- Research Score: 0.50
- Community Interest: 4 downloads, 35 likes
- [🤗 View on HuggingFace](https://huggingface.co/jedisct1/MiMo-V2.5-coder-Q2)

**huggingface/DEH-image-scan-data**

- Type: dataset
- Research Score: 0.50
- Community Interest: 10,246 downloads, 14 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/SOULAMA/qwen2.5-coder-ft)

**Muapi/donm-twisted-wonderland-flux**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Muapi/donm-twisted-wonderland-flux)

**Muapi/wai-cute-illustrationstyle**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Muapi/wai-cute-illustrationstyle)
...
- [mhdafifan/xlm-roberta-squad-id-LR-2e-05-BS-8](https://huggingface.co/mhdafifan/xlm-roberta-squad-id-LR-2e-05-BS-8)
- [mhdafifan/indobert-squad-id-LR-2e-05-BS-8](https://huggingface.co/mhdafifan/indobert-squad-id-LR-2e-05-BS-8)
...
- [spacegtn90/QWEN_Image_Edit_2511](https://huggingface.co/spacegtn90/QWEN_Image_Edit_2511)
...
- jedisct1/MiMo-V2.5-coder-Q2... (watch for citations and replications)
- huggingface/DEH-image-scan-data... (watch for citations and replications)
- SOULAMA/qwen2.5-coder-ft... (watch for citations and replications)
