...
**rajatt09/nutrition-llama3-new-merged-16bit**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rajatt09/nutrition-llama3-new-merged-16bit)

**Naphula/magnum-v4-9b-abliterated**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Naphula/magnum-v4-9b-abliterated)

**scinerd68/wav2vec2-large-xlsr-53-esperanto-asr-augment**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/scinerd68/wav2vec2-large-xlsr-53-esperanto-asr-augment)

**Ba2han/cpt-model-muon-3**

- Type: model
- Research Score: 0.40
- Community Interest: 119 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ba2han/cpt-model-muon-3)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/faizazmia/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-shiny_robust_moose)
