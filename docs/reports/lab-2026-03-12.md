...
**Terisara/student_emotion**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Terisara/student_emotion)

**seyhankokcu/functiongemma-270m-it-lokum-tool-calling**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/seyhankokcu/functiongemma-270m-it-lokum-tool-calling)

**CreitinGameplays/llama-3.2-3b-r1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/CreitinGameplays/llama-3.2-3b-r1)

**Riaan85/news-classification-model-neuron**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Riaan85/news-classification-model-neuron)
