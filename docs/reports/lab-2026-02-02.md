...
**sztal/erc-newsuse-valence**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sztal/erc-newsuse-valence)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pratap18/smollm2-highlish-Hinglish-Everyday-Conversations-1M_V3)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Wilsonwin/gpt2-chinese-mini)

**AIImageStudio/RadianceChromeVoluptuous_z_image_turbo_v2.0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AIImageStudio/RadianceChromeVoluptuous_z_image_turbo_v2.0)

**MohamedGomaa30/spark-tts-normazlied-masri-mega**

- Type: model
- Research Score: 0.40
- Community Interest: 377 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/MohamedGomaa30/spark-tts-normazlied-masri-mega)
...
- [pratap18/smollm2-highlish-Hinglish-Everyday-Conversations-1M_V3](https://huggingface.co/pratap18/smollm2-highlish-Hinglish-Everyday-Conversations-1M_V3)
- [Wilsonwin/gpt2-chinese-mini](https://huggingface.co/Wilsonwin/gpt2-chinese-mini)
- [naru0411/LLM-competition](https://huggingface.co/naru0411/LLM-competition)
...
- sztal/erc-newsuse-valence... (watch for citations and replications)
- pratap18/smollm2-highlish-Hinglish-Everyday-Conversations-1M... (watch for citations and replications)
- Wilsonwin/gpt2-chinese-mini... (watch for citations and replications)
