...
**acbueff/normistral-7b-instruct-nb-delta-dpo-nosft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acbueff/normistral-7b-instruct-nb-delta-dpo-nosft)

**Joshua-Abok/finetuning-wav2vec-large-swahili-asr-model_v11**

- Type: model
- Research Score: 0.40
- Community Interest: 81 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Joshua-Abok/finetuning-wav2vec-large-swahili-asr-model_v11)

**AaryanK/Qwen3.6-27B-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 2 likes
- [🤗 View on HuggingFace](https://huggingface.co/AaryanK/Qwen3.6-27B-GGUF)

**hendrik127/detr_fashionpedia**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hendrik127/detr_fashionpedia)

**taobao-mnn/Qwen3.6-27B-MNN**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/taobao-mnn/Qwen3.6-27B-MNN)
