...
**hamza-amin/whisper-small-urdu-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hamza-amin/whisper-small-urdu-v2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mrsmetamorphosis/dementia-wav2vec-scientific-specaugment-V3)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/boradorish/qwen3-4b-dpo)

**Beetle-HumanScale/beetle-bilingual-balanced-b1-humanscale-nld-eng-episodic**

- Type: model
- Research Score: 0.40
- Community Interest: 367 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Beetle-HumanScale/beetle-bilingual-balanced-b1-humanscale-nld-eng-episodic)

**unsloth/LTX-2.3-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 273,056 downloads, 323 likes
- [🤗 View on HuggingFace](https://huggingface.co/unsloth/LTX-2.3-GGUF)
...
- hamza-amin/whisper-small-urdu-v2... (watch for citations and replications)
- Mrsmetamorphosis/dementia-wav2vec-scientific-specaugment-V3... (watch for citations and replications)
- boradorish/qwen3-4b-dpo... (watch for citations and replications)
