...
- Type: dataset
- Research Score: 0.50
- Community Interest: 26,823 downloads, 315 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**continual-internalization/qwen3-30b-a3b-clog-ntp-lora-numpy-lr5e-5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/continual-internalization/qwen3-30b-a3b-clog-ntp-lora-numpy-lr5e-5)

**continual-internalization/qwen3-30b-a3b-clog-ntp-lora-numpy-lr1e-6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/continual-internalization/qwen3-30b-a3b-clog-ntp-lora-numpy-lr1e-6)
...
**SNSFL/SNSFL-Full-Corpus-Test**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SNSFL/SNSFL-Full-Corpus-Test)
...
- [octava/whisper-small-ablation-add-NldLlm](https://huggingface.co/octava/whisper-small-ablation-add-NldLlm)
- [dtran612/TRAIN_SET-phobert-base-vianli-ph](https://huggingface.co/dtran612/TRAIN_SET-phobert-base-vianli-ph)
...
- continual-internalization/qwen3-30b-a3b-clog-ntp-lora-numpy-... (watch for citations and replications)
- continual-internalization/qwen3-30b-a3b-clog-ntp-lora-numpy-... (watch for citations and replications)
