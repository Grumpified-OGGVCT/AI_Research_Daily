...
**0d1n/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-restless_plump_bison**

- Type: model
- Research Score: 0.40
- Community Interest: 513 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/0d1n/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-restless_plump_bison)

**Trouter-Library/Trouter-Terminus-20b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Trouter-Library/Trouter-Terminus-20b)

**dongwookkwon/qwen0.5b-tech-interview-test**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dongwookkwon/qwen0.5b-tech-interview-test)
...
**Kibalama/smollm3-jobs-sft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kibalama/smollm3-jobs-sft)
...
- 0d1n/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-restless_plump_bison... (watch for citations and replications)
- Trouter-Library/Trouter-Terminus-20b... (watch for citations and replications)
- dongwookkwon/qwen0.5b-tech-interview-test... (watch for citations and replications)
