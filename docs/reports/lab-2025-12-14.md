...
- **Implementation Watch**: 29 new models/datasets on HuggingFace
...
- [🤗 View on HuggingFace](https://huggingface.co/ik-ram28/SFT-Mistral-instruct-CPT-7b-New)
...
**Thrillcrazyer/Qwen1.5_GSPO_1214**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Thrillcrazyer/Qwen1.5_GSPO_1214)

**mlkro/Llama-3.2-1B-Instruct-PT-SynthDolly-2B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mlkro/Llama-3.2-1B-Instruct-PT-SynthDolly-2B)

**snoop2head/dclm-llama-0.8B-1x**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/snoop2head/dclm-llama-0.8B-1x)
...
- ik-ram28/SFT-Mistral-instruct-CPT-7b-New... (watch for citations and replications)
- chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-graceful... (watch for citations and replications)
- Thrillcrazyer/Qwen1.5_GSPO_1214... (watch for citations and replications)
...
- **Total Papers Scanned**: 29
- **High-Relevance Papers**: 29
