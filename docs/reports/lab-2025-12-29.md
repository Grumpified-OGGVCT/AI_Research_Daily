...
**eekay/Qwen2.5-3b-instruct-lion-numbers-ft**

- Type: model
- Research Score: 0.40
- Community Interest: 7 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/eekay/Qwen2.5-3b-instruct-lion-numbers-ft)

**newmindai/bge-m3-stsb-onnx**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/newmindai/bge-m3-stsb-onnx)
...
**younoson/llama-angles-8b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/younoson/llama-angles-8b)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/123cccc/output)
...
- eekay/Qwen2.5-3b-instruct-lion-numbers-ft... (watch for citations and replications)
- newmindai/bge-m3-stsb-onnx... (watch for citations and replications)
- anonymous6011/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-tiny_... (watch for citations and replications)
