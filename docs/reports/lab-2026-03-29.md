...
**mokshijain22/news-bias-detector**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mokshijain22/news-bias-detector)

**Tornado-Labs/Evil-Genius-Llama-3.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Tornado-Labs/Evil-Genius-Llama-3.1)

**koryo10/sarashina-line-doc-dynamic-no-vision-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/koryo10/sarashina-line-doc-dynamic-no-vision-lora)

**koryo10/sarashina-line-doc-dynamic-no-proj-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/koryo10/sarashina-line-doc-dynamic-no-proj-lora)

**koryo10/sarashina-line-doc-dynamic-no-llm-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/koryo10/sarashina-line-doc-dynamic-no-llm-lora)
...
- mokshijain22/news-bias-detector... (watch for citations and replications)
- Tornado-Labs/Evil-Genius-Llama-3.1... (watch for citations and replications)
- koryo10/sarashina-line-doc-dynamic-no-vision-lora... (watch for citations and replications)
