...
**mohitskaushal/phi4-mini-indian-geography-lora-merged**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mohitskaushal/phi4-mini-indian-geography-lora-merged)

**ryoto0175/dpo-qwen-cot-merged-v20**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ryoto0175/dpo-qwen-cot-merged-v20)
...
- [🤗 View on HuggingFace](https://huggingface.co/marcostrfn/bart-base-spanish-nli-taller-test)

**Backup-CaML/40K_mixed_animals_three_fourths_alpaca_only_persona_plainprompts**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Backup-CaML/40K_mixed_animals_three_fourths_alpaca_only_persona_plainprompts)

**ferrazzipietro/crfTask-unsup-Llama-3.2-1B-Instruct-datav2-60k**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ferrazzipietro/crfTask-unsup-Llama-3.2-1B-Instruct-datav2-60k)
...
- mohitskaushal/phi4-mini-indian-geography-lora-merged... (watch for citations and replications)
- ryoto0175/dpo-qwen-cot-merged-v20... (watch for citations and replications)
- marcostrfn/bart-base-spanish-nli-taller-test... (watch for citations and replications)
