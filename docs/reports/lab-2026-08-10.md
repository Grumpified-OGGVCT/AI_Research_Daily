...
- Type: dataset
- Research Score: 0.50
- Community Interest: 28,115 downloads, 340 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**KairodyneDynamics-AI/Fit-Flash**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/KairodyneDynamics-AI/Fit-Flash)

**ISdept/qwen-4b-libero-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ISdept/qwen-4b-libero-lora)

**sullivan1502/base-action-sft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sullivan1502/base-action-sft)

**layaiyer/emotionalFT-hyp-news-nouns-dict-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/layaiyer/emotionalFT-hyp-news-nouns-dict-lora)
...
- KairodyneDynamics-AI/Fit-Flash... (watch for citations and replications)
- ISdept/qwen-4b-libero-lora... (watch for citations and replications)
