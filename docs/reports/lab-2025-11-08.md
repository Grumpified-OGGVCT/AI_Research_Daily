...
- [🤗 View on HuggingFace](https://huggingface.co/KT30611/Qwen3-0.6B-Gensyn-Swarm-pudgy_tropical_snail)

**arthurbittencourt/distillGPT2-dblp_6_a-fold0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/arthurbittencourt/distillGPT2-dblp_6_a-fold0)

**aarontseng/meteor-8-11-2025-16bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aarontseng/meteor-8-11-2025-16bit)

**anzceel/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-jagged_sly_boar**

- Type: model
- Research Score: 0.40
- Community Interest: 462 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/anzceel/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-jagged_sly_boar)

**DevQuasar/moonshotai.Kimi-K2-Thinking-BF16**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/moonshotai.Kimi-K2-Thinking-BF16)
