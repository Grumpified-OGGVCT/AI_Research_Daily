...
- [🤗 View on HuggingFace](https://huggingface.co/Thrillcrazyer/Qwen-1.5B_THIP_RLOO)

**ButterChicken98/soy_bact_pustule_depth_controlnet_v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ButterChicken98/soy_bact_pustule_depth_controlnet_v1)
...
- Thrillcrazyer/Qwen-1.5B_THIP_RLOO... (watch for citations and replications)
- ButterChicken98/soy_bact_pustule_depth_controlnet_v1... (watch for citations and replications)
