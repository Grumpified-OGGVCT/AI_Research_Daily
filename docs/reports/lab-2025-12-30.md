...
**acengnew/environmental-cue-response-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acengnew/environmental-cue-response-model)

**acengnew/micro-instruction-label-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/acengnew/micro-instruction-label-model)

**Tino3141/4SpeakersDropCocktail100000**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/Tino3141/4SpeakersDropCocktail100000)

**gjyotin305/Qwen2.5-3B-Instruct_adaptive_tune_2e5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gjyotin305/Qwen2.5-3B-Instruct_adaptive_tune_2e5)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/HY-MT1.5-7B-GGUF)
