...
**virusf/nllb-renpy-rory-v6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/virusf/nllb-renpy-rory-v6)

**aayush1306/finetune-oss-v9-full-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aayush1306/finetune-oss-v9-full-4bit)

**SamMikaelson/SchemaTuned-GemmaLoraMain2Epoch**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SamMikaelson/SchemaTuned-GemmaLoraMain2Epoch)

**yujingsun/stable-diffusion-2-1-base**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yujingsun/stable-diffusion-2-1-base)

**nightmedia/Qwen3-VL-43B-A3B-Thinking-HQ16-BX20-qx65-hi-mlx**

- Type: model
- Research Score: 0.40
- Community Interest: 19 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nightmedia/Qwen3-VL-43B-A3B-Thinking-HQ16-BX20-qx65-hi-mlx)
