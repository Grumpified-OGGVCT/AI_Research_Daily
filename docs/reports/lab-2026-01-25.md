...
- [🤗 View on HuggingFace](https://huggingface.co/Ateeqq/food-analysis)

**JPQ24/Natural-synthesis-llama-3.2-1b-merge**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/JPQ24/Natural-synthesis-llama-3.2-1b-merge)

**Julianvn/facts-fw-med-new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Julianvn/facts-fw-med-new)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mewaeltsegay/desta_1b)

**Bl4ckSpaces/Ilustrious-Nova-V3-TIES**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Bl4ckSpaces/Ilustrious-Nova-V3-TIES)
...
- Ateeqq/food-analysis... (watch for citations and replications)
- JPQ24/Natural-synthesis-llama-3.2-1b-merge... (watch for citations and replications)
- Julianvn/facts-fw-med-new... (watch for citations and replications)
