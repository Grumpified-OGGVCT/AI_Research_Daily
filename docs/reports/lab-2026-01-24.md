...
**LLM-course/chess_new_b**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess_new_b)

**jeqcho/qwen-2.5-1.5b-instruct-tiger-ft-epoch-7**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jeqcho/qwen-2.5-1.5b-instruct-tiger-ft-epoch-7)
...
- [🤗 View on HuggingFace](https://huggingface.co/ali-elganzory/1.7b-MixtureVitae-300BT-v1-decontaminated-SFT-Tulu3)

**Ravi9058/ParentGPT_RaviPrakash**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ravi9058/ParentGPT_RaviPrakash)

**LLM-course/chess-etiennelefranc-v6**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLM-course/chess-etiennelefranc-v6)
